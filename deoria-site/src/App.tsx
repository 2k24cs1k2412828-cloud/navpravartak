...
export const deoria: Destination = {
  id: "deoria",
  slug: "deoria-uttar-pradesh",
  name: "Deoria",
  localName: "देवरिया",
  destinationType: "Sacred Hermitage & River City",
  country: "India",
  state: "Uttar Pradesh",
  district: "Deoria",
  shortDescription: "Sanctuary of Devraha Baba, ancient Shiva shrines, and serene Saryu ghats.",
  tags: ["SPIRITUAL", "RIVER GHATS", "PILGRIMAGE"],
  hero: {
    image: "/images/deoria_hero_fullhd.jpg",
    poster: "/images/deoria_peda.jpg"
  },
  quickFacts: {
    bestTime: "Oct – Mar",
    duration: "1–2 Days",
    budget: "₹",
    destinationType: "Spiritual & Temple Town",
    difficulty: "Easy",
    distance: '~50 km from Gorakhpur'
  },
  discoveryScore: {
    overall: 8.3,
    categories: [
      { name: "Spiritual Aura", score: 9.4 },
      { name: "Cultural Value", score: 8.7 },
      { name: "Historical Significance", score: 8.5 },
      { name: "Local Experience", score: 8.8 },
      { name: "Peace & Quiet", score: 9.2 }
    ]
  },
  editorial: {
    why: "Deoria is a tranquil spiritual sanctuary resting in the fertile plains between the sacred Saryu (Ghaghara) and Gandak rivers. Revered as the seat of the immortal yogi Devraha Baba and home to the millennium-old Dudheshwar Nath Shiva temple, it offers profound spiritual calm away from urban rush.",
    story: "For centuries, seekers have journeyed to Deoria's quiet riverbank town of Barhaj, often called Mini Kashi. Here, Devraha Baba lived atop a high wooden machan over the river, blessing saints, prime ministers, and ordinary villagers alike with selfless love.",
    storyFull: 'The medieval fortress ruins of Majhauli Raj speak of ancient Kshatriya kingdoms along the Gandak, while Rudrapur houses the colossal ancient Shivling of Dudheshwar Nath. In the evening, the lamps floating down the Saryu at Barhaj Ghat illuminate waters sacred since the Vedic era. The town\'s sweet shops brim with fresh Gud ki Kheer and melt-in-mouth Chhena confections.'
  },
  history: {
    shortIntro: "A sacred land of immortal yogis, Shiva lingams, and medieval kings.",
    timeline: [
      { year: "Ancient Era", event: "Part of the ancient Kosala Kingdom and Buddhist pilgrimage travel circuits", era: "Ancient Kosala" },
      { year: "12th Century", event: "Rise of the medieval Majhauli Raj dynasty ruling the Gandak and Saryu riverbanks", era: "Medieval Era" },
      { year: "1946", event: "Deoria officially carved out from Gorakhpur as an independent district", era: "Modern Era" },
      { year: "1990", event: "Devraha Baba attains Mahasamadhi on Yogini Ekadashi on the sacred banks of the Yamuna/Saryu", era: "Spiritual Legacy" },
      { year: "2020", event: "Barhaj Ghats and Dudheshwar Nath corridor development under UP Tourism circuit", era: "Contemporary" }
    ]
  },
  culture: [
    {
      title: "Devraha Baba Hermitage",
      description: "The sublime memory and continuous Akhand Kirtan at the ashram preserve the timeless ascetic yogic traditions of northern India.",
      image: 'https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=600&h=400&fit=crop&auto=format'
    },
    {
      title: "Barhaj Saryu Aarti",
      description: "Known as \"Chhoti Kashi\", the river ghats of Barhaj witness evening conch shells, brass lamp aartis, and devout riverside prayers.",
      image: '/images/river_aarti.jpg'
    },
    {
      title: "Rudrapur Temple Fairs",
      description: "During Maha Shivratri, tens of thousands of devotees pour into Rudrapur for holy abhishekam of Baba Dudheshwar Nath.",
      image: 'https://images.unsplash.com/photo-1627894483216-2138af692e32?w=600&h=400&fit=crop&auto=format'
    },
    {
      title: "Sugar & Agro Heritage",
      description: "Known historically as the sugar bowl of eastern UP, with sweet-smelling sugarcane fields and traditional jaggery (gur) making.",
      image: 'https://images.unsplash.com/photo-1663089551295-cee8e58807a0?w=600&h=400&fit=crop&auto=format'
    }
  ],
  food: [
    {
      name: "Deoria ke Prasiddh Peda",
      description: "Deoria's iconic caramelized milk fudge prepared from slow-simmered khoya and green cardamom, famous across local sweet shops and eastern UP railway stations.",
      category: "Signature Sweet",
      price: "₹300–₹450/kg",
      image: '/images/deoria_peda.jpg'
    },
    {
      name: "Purvanchali Litti Chokha",
      description: "Authentic charcoal-roasted whole wheat dough balls stuffed with spiced roasted sattu, served with smoked aubergine-tomato chokha and desi ghee.",
      category: "Main Course",
      price: "₹50–₹100",
      image: '/images/litti_chokha.jpg'
    },
    {
      name: "Gud ki Kheer (Rasiya)",
      description: "Fragrant local rice slow-cooked in thick milk with organic sugarcane jaggery, cardamom, and toasted cashews, honoring Deoria's sugarcane heritage.",
      category: "Traditional Sweet",
      price: "₹50–₹90",
      image: '/images/kheer.jpg'
    },
    {
      name: "Chhena Goja & Malpua",
      description: "Delicate artisanal cheese confections and golden malpuas steeped in saffron-cardamom syrup, freshly made at Barhaj and Deoria bazaars.",
      category: "Dessert",
      price: "₹40–₹80",
      image: '/images/malpua.jpg'
    },
    {
      name: "Kachori Tarkari & Jalebi",
      description: "Crispy golden kachoris stuffed with spiced urad dal, served with aromatic hing-aloo tarkari and freshly fried syrup-soaked jalebi.",
      category: "Breakfast",
      price: "₹30–₹60",
  ...
  attractions: [
    {
      id: "devraha-baba-ashram",
      name: "Devraha Baba Ashram, Barhaj",
      category: "Spiritual Hermitage",
      description: "The peaceful sacred ashram of the venerated saint Devraha Baba on the holy Saryu riverbanks, emitting profound peace.",
      duration: "2 hrs",
      distance: "30 km from Deoria",
      score: 9.5,
      image: 'https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=600&h=420&fit=crop&auto=format'
    },
    {
      id: "dudheshwar-nath",
      name: "Dudheshwar Nath Mandir, Rudrapur",
      category: "Ancient Shiva Temple",
      description: "Famed thousand-year-old Shiva shrine housing a massive subterranean Shivling with extraordinary spiritual aura.",
      duration: "1.5 hrs",
    ...
    {
      id: "barhaj-saryu-ghat",
      name: "Barhaj Saryu River Ghat",
      category: "Riverfront & Pilgrimage",
      description: "Serene stone steps along the sacred Saryu river, famous for sunrise prayers, sacred dips, and evening aarti.",
      duration: "1.5 hrs",
      distance: "32 km from town",
      score: 9.0,
      image: 'https://images.unsplash.com/photo-1627894483216-2138af692e32?w=600&h=420&fit=crop&auto=format'
    },
    {
      id: "majhauli-raj-fort",
      name: "Majhauli Raj Fort",
      category: "Historical Heritage",
      description: "Ruins and royal gateway of the medieval Majhauli estate dynasty along the Gandak river, rich in Rajput lore.",
      duration: "1 hr",
      distance: "25 km east",
      score: 8.2,
    ...
    {
      id: "tirupati-balaji-temple",
      name: "Tirupati Balaji Temple",
      category: "Modern Temple",
      description: "A striking Dravidian-style south-Indian temple dedicated to Lord Venkateshwara, rare in eastern Uttar Pradesh.",
      duration: "1 hr",
  ...
  hiddenGems: [
    {
      name: "Devrahi Mata Mandir",
      why: "Ancient folk goddess shrine deeply revered by regional villagers for wish-fulfillment, set in calm rural countryside.",
    ...
    {
      name: "Gandak River Sandbanks",
      why: "Untouched pristine sandy river shores near Salempur where waterbirds roost during sunrise and sunset.",
      distance: "28 km east",
      duration: "1 hr",
  ...
  thingsToDo: [
    { activity: "Evening Aarti at Barhaj Ghat", duration: "1.5 hrs", cost: "Free", difficulty: "Easy", bestTime: "6:00 PM, All year", image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?w=600&h=400&fit=crop&auto=format" },
    { activity: "Meditation at Devraha Baba Ashram", duration: "2 hrs", cost: "Free", difficulty: "Easy", bestTime: "Early morning", image: "https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=600&h=400&fit=crop&auto=format" },
    { activity: "Shiva Abhishekam at Dudheshwar Nath", duration: "1.5 hrs", cost: "Free", difficulty: "Easy", bestTime: "Morning 7–10 AM", image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?w=600&h=400&fit=crop&auto=format" },
    { activity: "Deoria Sweet Trail & Gud ki Kheer", duration: "1.5 hrs", cost: "₹100–₹250", difficulty: "Easy", bestTime: "Evening", image: "https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=600&h=400&fit=crop&auto=format" }
  ],
  nearbyPlaces: [
    { name: "Gorakhpur", distance: "50 km", type: "Metropolis & Temple", travelTime: "1 hr", image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?w=500&h=340&fit=crop&auto=format" },
    { name: "Kushinagar", distance: "35 km", type: "International Buddhist Site", travelTime: "45 min", image: "https://images.unsplash.com/photo-1609137144822-491c13d78905?w=500&h=340&fit=crop&auto=format" },
    { name: "Ballia", distance: "85 km", type: "River Heritage", travelTime: "2 hrs", image: "https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=500&h=340&fit=crop&auto=format" },
    { name: "Varanasi", distance: "180 km", type: "Spiritual Capital", travelTime: "4 hrs", image: "https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=500&h=340&fit=crop&auto=format" }
  ],
  travel: {
    air: { airport: "Gorakhpur Airport (GOP)", distance: "55 km", time: "~1 hr 15 min by taxi" },
    rail: { station: "Deoria Sadar Railway Station (DEOS)", distance: "City centre", time: "Major mainline stop between Gorakhpur and Bihar" },
    road: { highway: "Gorakhpur-Deoria-Salempur Highway", distance: "52 km from Gorakhpur", time: "1 hr by bus or cab" }
  },
  stay: {
    categories: [
      { type: "Budget", range: "₹600–₹1,400/night", options: ["Hotel Shiva Deoria", "Hotel Grand Plaza", "Station Road Lodges"] },
      { type: "Mid-Range", range: "₹1,800–₹3,200/night", options: ["Hotel Utsav", "Hotel Raj International"] },
      { type: "Ashram Stay", range: "Donation-based / ₹300", options: ["Barhaj Pilgrim Guesthouses", "Dudheshwar Nath Dharmashala"] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: "Pilgrim / Budget", perDay: "₹700–₹1,300", breakdown: [{ category: "Stay", amount: "₹400–₹700" }, { category: "Food", amount: "₹200–₹350" }, { category: "Transport", amount: "₹100–₹250" }] },
      { tier: "Comfort", perDay: "₹1,800–₹3,500", breakdown: [{ category: "Stay", amount: "₹1,200–₹2,200" }, { category: "Food", amount: "₹350–₹700" }, { category: "Transport", amount: "₹250–₹600" }] }
    ]
  },
  itineraries: {
    '1 Day': [
      {
        day: 1,
        schedule: [
          { time: "7:30 AM", place: "Dudheshwar Nath Shiva Temple Rudrapur", duration: "2 hrs", distance: "20 km south" },
          { time: "10:00 AM", place: "Breakfast: Kachori Tarkari & Deoria Peda", duration: "45 min", distance: "Rudrapur market" },
          { time: "11:30 AM", place: "Tirupati Balaji Temple Darshan", duration: "1 hr", distance: "City" },
          { time: "1:30 PM", place: "Lunch & Fresh Samosa Chaat", duration: "1 hr", distance: "Deoria Chowk" },
          { time: "3:30 PM", place: "Devraha Baba Ashram, Barhaj", duration: "2 hrs", distance: "30 km" },
          { time: "6:00 PM", place: "Barhaj Saryu River Sunset Aarti", duration: "1.5 hrs", distance: "Barhaj Ghat" }
        ]
      }
    ],
    '2 Days': [
      {
        day: 1,
        schedule: [
          { time: "8:00 AM", place: "Dudheshwar Nath Mandir Abhishekam", duration: "2 hrs", distance: "Rudrapur" },
          { time: "11:30 AM", place: "Majhauli Raj Fort ruins exploration", duration: "1.5 hrs", distance: "25 km" },
          { time: "4:00 PM", place: "Barhaj Saryu Ghat and riverboat ride", duration: "2.5 hrs", distance: "Barhaj" },
          { time: "7:30 PM", place: "Evening Aarti and Gud ki Kheer tasting", duration: "1.5 hrs", distance: "Barhaj" }
        ]
      },
      {
        day: 2,
        schedule: [
          { time: "7:00 AM", place: "Morning prayers at Devraha Baba Hermitage", duration: "2 hrs", distance: "Barhaj" },
          { time: "10:00 AM", place: "Day trip to nearby Kushinagar (Mahaparinirvana Temple)", duration: "4 hrs", distance: "35 km" },
          { time: "4:00 PM", place: "Tirupati Balaji Temple & Deoria local market", duration: "2 hrs", distance: "Deoria" }
        ]
      }
    ]
  },
  experiences: [
    { title: "Barhaj Saryu River Sunset Aarti Walk", duration: "2 hrs", price: "₹250–₹500", category: "Spiritual", image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?w=600&h=400&fit=crop&auto=format" },
    { title: "Devraha Baba Hermitage Meditation Experience", duration: "2 hrs", price: "Donation-based", category: "Wellness", image: "https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=600&h=400&fit=crop&auto=format" }
  ],
  aiPrompts: [
    "How far is Devraha Baba Ashram from Deoria railway station?",
    "What is the history of Dudheshwar Nath Mandir in Rudrapur?",
    "How to combine Deoria and Kushinagar in a 2-day trip?",
    'Best breakfast and sweets in Deoria town?'
  ],
  reviews: [
    { name: "Amitabh Tripathi", location: "Gorakhpur", text: "Barhaj ghats at sunset have the same sacred peace as Varanasi but with complete silence and authenticity.", rating: 5, image: "https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=80&h=80&fit=crop&auto=format", date: "February 2026" },
    { name: "Sunil Pandey", location: "Patna", text: "The ancient Shiva temple at Rudrapur is powerful. Excellent guide to local food and transport.", rating: 5, image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?w=80&h=80&fit=crop&auto=format", date: "December 2025" }
  ],
  sources: {
    official: ["Uttar Pradesh Tourism (uptourism.gov.in)", "District Deoria Portal (deoria.nic.in)"],
    historical: ["Archaeological Survey Reports of Eastern UP", "Hagiography of Yogis of North India"],
...
export default function App() {
  const destination: Destination = deoria
