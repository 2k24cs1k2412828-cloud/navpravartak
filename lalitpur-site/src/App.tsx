...
const lalitpur: Destination = {
  id: 'lalitpur', slug: 'lalitpur-uttar-pradesh', name: 'Lalitpur', localName: 'ललितपुर',
  destinationType: 'Heritage & Waterfalls City', country: 'India', state: 'Uttar Pradesh', district: 'Lalitpur',
  established: { year: '16th Century AD', by: 'Raja Sumer Singh' },
  shortDescription: 'Land of ancient Gupta temples, medieval Bundela forts, cascading waterfalls, and rock-cut heritage.',
  tags: ['HERITAGE', 'HISTORICAL', 'WATERFALLS', 'CULTURAL'],
  hero: {
    image: 'https://preview.redd.it/a-random-evening-view-from-lalitpur-v0-jicjx0l5i7he1.jpeg?format=pjpg&auto=webp&s=0cfca487877eb922db60cce6ad801dfcd36dcaf2',
    poster: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?w=1920&h=1080&fit=crop&auto=format'
  },
  quickFacts: {
    bestTime: 'Oct – Mar', duration: '2–3 Days', budget: '₹₹',
    destinationType: 'Heritage City', difficulty: 'Easy', distance: '~90 km from Jhansi'
  },
  discoveryScore: {
    overall: 8.5,
    categories: [
      { name: 'Uniqueness', score: 9.0 },
      { name: 'Historical Significance', score: 9.4 },
      { name: 'Cultural Value', score: 8.8 },
      { name: 'Crowd Level', score: 4.5 },
      { name: 'Local Experience', score: 8.2 }
    ]
  },
  editorial: {
    why: 'Lalitpur is a hidden cradle of Indian temple architecture and Bundeli bravery. Home to Deogarh\'s famous 5th-century Dashavatara Temple and pristine Betwa waterfalls, it offers an unspoiled heritage journey away from mass tourism.',
    story: 'Nestled in the heart of Bundelkhand on ancient trade routes between northern and central India, Lalitpur has witnessed the golden age of the Gupta Dynasty, Chandela rulers, and valiant Bundela chieftains.',
    storyFull: 'The majestic Deogarh Fort atop the cliffs of Betwa River houses one of the earliest standing stone temples in northern India, featuring masterfully carved relief panels of Lord Vishnu. Combined with scenic waterfalls like Rajghat, lakeside forts at Talbehat, and rich Jain pilgrimage traditions, Lalitpur balances ancient history with peaceful natural landscapes.'
  },
  history: {
    shortIntro: 'A timeless land where Gupta art meets medieval Bundela fortresses along the Betwa River.',
    timeline: [
      { year: '5th Century CE', event: 'Construction of the Dashavatara Temple at Deogarh during the Gupta Empire, creating early masterpiece of stone temple architecture', era: 'Gupta Era' },
      { year: '9th-11th Century', event: 'Chandela kings fortify Deogarh and surrounding hills, establishing Jain temple complexes', era: 'Chandela Era' },
      { year: '1618', event: 'Raja Bharat Shah of Chanderi state builds Talbehat Fort along the artificial lake', era: 'Bundela Era' },
      { year: '1857', event: 'Lalitpur plays an active role in the Indian Freedom Struggle with Bundela rebels resisting British forces', era: 'Freedom Movement' },
      { year: '1974', event: 'Lalitpur officially formed as a distinct district of Uttar Pradesh carved out from Jhansi district', era: 'Modern Era' }
    ]
  },
  culture: [
    { title: 'Gupta Architecture', description: 'Deogarh in Lalitpur is globally renowned for founding the classic Panchayatana style of Indian temple architecture with intricate stone carving.', image: 'https://images.unsplash.com/photo-1600100397608-f010e423b961?w=600&h=400&fit=crop&auto=format' },
    { title: 'Bundeli Folklore & Crafts', description: 'Deeply connected to Bundeli folk music, heroic ballads of Alha-Udal, traditional wood carving, and brassware heritage.', image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=600&h=400&fit=crop&auto=format' },
    { title: 'Jain Pilgrimage Heritage', description: 'Deogarh houses 31 ancient Jain temples dating from 8th to 14th centuries with thousands of carved idols and Tirthankara panels.', image: 'https://images.unsplash.com/photo-1544717305-2782549b5136?w=600&h=400&fit=crop&auto=format' },
    { title: 'Lakeside Living', description: 'Towns like Talbehat preserve an unhurried, peaceful rural lifestyle built around pristine water bodies and ancient stepwells.', image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600&h=400&fit=crop&auto=format' }
  ],
  food: [
    { name: 'Lalitpur ke Samose', description: 'Distinct large-sized samosas stuffed with fragrant potato filling spiced with crushed coriander seeds, fennel, and local herbs. Served piping hot with tangy imli chutney.', category: 'Street Food', price: '₹20–₹40', image: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=500&h=360&fit=crop&auto=format' },
    { name: 'Bundeli Aloo Baingan', description: 'Rustic, dry fried potatoes and eggplants tempered with mustard seeds, turmeric, red chili, and hing. A flavorful staple of Bundelkhand.', category: 'Main Course', price: '₹80–₹150', image: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=500&h=360&fit=crop&auto=format' },
    { name: 'Til ke Ladoo', description: 'Nutritious winter sweet made from roasted sesame seeds, jaggery, peanuts, and pure desi ghee, essential during Sankranti.', category: 'Sweet', price: '₹150–₹300/kg', image: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=500&h=360&fit=crop&auto=format' },
    { name: 'Bundeli Thali', description: 'A traditional, wholesome Bundelkhandi feast featuring split urad dal Bara soaked in buttermilk, tangy Bundeli Kadhi, Meeda, Besan ke Aloo, hot rotis, and rice cooked with local spices and pure desi ghee.', category: 'Main Course', price: '₹120–₹220', image: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=500&h=360&fit=crop&auto=format' }
  ],
  attractions: [
    { id: 'deogarh-fort', name: 'Deogarh Fort & Dashavatara Temple', category: 'Gupta Heritage', description: 'Hilltop fort housing the iconic 5th-century Dashavatara Vishnu Temple and 31 historic Jain temples overlooking the Betwa river.', duration: '3–4 hrs', distance: '30 km from Lalitpur', score: 9.6, image: 'https://images.unsplash.com/photo-1600100397608-f010e423b961?w=600&h=420&fit=crop&auto=format' },
    { id: 'rajghat-waterfall', name: 'Rajghat Waterfall & Dam', category: 'Natural Waterfall', description: 'Spectacular cascade on Betwa river dropping over rocky cliffs, creating lush surroundings especially during post-monsoon months.', duration: '2–3 hrs', distance: '25 km from town', score: 9.0, image: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=600&h=420&fit=crop&auto=format' },
    { id: 'talbehat-fort', name: 'Talbehat Fort & Mansarovar Lake', category: 'Lakeside Fort', description: 'Scenic 17th-century Bundela fort built on the edge of a serene artificial lake, offering romantic lake views and historic ramparts.', duration: '2 hrs', distance: '40 km from Lalitpur', score: 8.8, image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600&h=420&fit=crop&auto=format' },
    { id: 'mahavir-sanctuary', name: 'Mahavir Swami Wildlife Sanctuary', category: 'Wildlife & Nature', description: 'Lush sanctuary spread across 5.4 sq km, home to leopards, hyenas, jackals, blue bulls, and diverse avian species.', duration: '2–3 hrs', distance: '32 km from town', score: 8.4, image: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=600&h=420&fit=crop&auto=format' }
  ],
  hiddenGems: [
    { name: 'Mata Parvati Cave Temple (Deogarh Hill)', why: 'Ancient rock-cut cave temple dedicated to Goddess Parvati with natural cool air, rock-carved deities, and serene spiritual vibe.', distance: 'Inside Deogarh Fort', duration: '45 min', image: 'https://images.unsplash.com/photo-1544717305-2782549b5136?w=800&h=500&fit=crop&auto=format' },
    { name: 'Ranchhorji Temple (Dhawa)', why: 'Quiet Krishna temple set amidst tranquil countryside with medieval architecture and peaceful bathing ghats.', distance: '15 km from city', duration: '1 hr', image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=800&h=500&fit=crop&auto=format' }
  ],
  thingsToDo: [
    { activity: 'Deogarh Gupta Art Trail', duration: '3 hrs', cost: '₹200–₹500', difficulty: 'Easy', bestTime: 'Morning, Oct–Mar', image: 'https://images.unsplash.com/photo-1600100397608-f010e423b961?w=600&h=400&fit=crop&auto=format' },
    { activity: 'Rajghat Waterfall Picnic & Birding', duration: '3 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Post-Monsoon (Sep–Dec)', image: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=600&h=400&fit=crop&auto=format' },
    { activity: 'Talbehat Lake Sunset Walk', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: '5:00 PM', image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600&h=400&fit=crop&auto=format' }
  ],
  nearbyPlaces: [
    { name: 'Chanderi (MP)', distance: '45 km', type: 'Heritage & Saree Town', travelTime: '1 hr', image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=500&h=340&fit=crop&auto=format' },
    { name: 'Jhansi', distance: '90 km', type: 'Historical City', travelTime: '1.5 hrs', image: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?w=500&h=340&fit=crop&auto=format' },
    { name: 'Orchha (MP)', distance: '105 km', type: 'Bundela Heritage', travelTime: '2 hrs', image: 'https://images.unsplash.com/photo-1600100397608-f010e423b961?w=500&h=340&fit=crop&auto=format' }
  ],
  travel: {
    air: { airport: 'Gwalior Airport (GWL) / Bhopal (BHO)', distance: '190 km', time: '~3.5 hrs by taxi' },
    rail: { station: 'Lalitpur Junction (LAR)', distance: 'City centre', time: 'Direct trains from Delhi, Mumbai, Bhopal, Jhansi' },
    road: { highway: 'NH-44 (North-South Corridor)', distance: 'Connected directly via NH-44', time: '1.5 hrs from Jhansi by road' }
  },
  stay: {
    categories: [
      { type: 'Budget', range: '₹500–₹1,200/night', options: ['Hotel Bundelkhand', 'Lalitpur Guest House', 'Local lodges near Railway Station'] },
      { type: 'Mid-Range', range: '₹1,800–₹3,500/night', options: ['Hotel Shri Anand', 'Hotel Park Residency', 'UP Tourism Resort'] },
      { type: 'Heritage / Homestay', range: '₹1,500–₹3,000/night', options: ['Bundeli Homestays near Talbehat', 'Chanderi Heritage Stays'] }
    ]
  },
  bestTime: {
    months: [
      ...
      { month: 'Jul', status: 'good' }, { month: 'Aug', status: 'good' }, { month: 'Sep', status: 'ideal' },
      { month: 'Oct', status: 'ideal' }, { month: 'Nov', status: 'ideal' }, { month: 'Dec', status: 'ideal' }
    ]
  },
  budget: {
    tiers: [
      { tier: 'Budget Traveller', perDay: '₹1,200–₹1,800', breakdown: [{ category: 'Stay', amount: '₹500–₹800' }, { category: 'Food', amount: '₹250–₹400' }, { category: 'Transport', amount: '₹200–₹300' }, { category: 'Entry Fees', amount: '₹100–₹200' }, { category: 'Activities', amount: '₹150' }] },
      { tier: 'Comfort', perDay: '₹2,500–₹4,500', breakdown: [{ category: 'Stay', amount: '₹1,500–₹2,500' }, { category: 'Food', amount: '₹500–₹800' }, { category: 'Transport', amount: '₹400–₹700' }, { category: 'Entry Fees', amount: '₹200' }, { category: 'Activities', amount: '₹400' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '8:00 AM', place: 'Lalitpur ke Samosa Breakfast', duration: '45 min', distance: 'City centre' }, { time: '9:30 AM', place: 'Deogarh Fort & Dashavatara Temple', duration: '3 hrs', distance: '30 km' }, { time: '1:30 PM', place: 'Lunch — Bundeli Thali', duration: '1 hr', distance: 'Deogarh / City' }, { time: '3:30 PM', place: 'Rajghat Waterfall on Betwa River', duration: '2 hrs', distance: '25 km' }, { time: '6:00 PM', place: 'Talbehat Fort & Lake Sunset View', duration: '1.5 hrs', distance: '40 km' }] }],
    '2 Days': [{ day: 1, schedule: [{ time: '9:00 AM', place: 'Deogarh Fort & Gupta Sculpture Trail', duration: '3 hrs', distance: '30 km' }, { time: '1:00 PM', place: 'Mata Parvati Cave Temple', duration: '1 hr', distance: 'Deogarh Hill' }, { time: '3:30 PM', place: 'Rajghat Waterfall & Betwa River view', duration: '2.5 hrs', distance: '25 km' }] }, { day: 2, schedule: [{ time: '9:00 AM', place: 'Talbehat Fort & Mansarovar Lake', duration: '2.5 hrs', distance: '40 km' }, { time: '12:30 PM', place: 'Mahavir Swami Wildlife Sanctuary', duration: '2.5 hrs', distance: '32 km' }, { time: '4:00 PM', place: 'Chanderi Saree & Silk Craft Market Visit', duration: '2 hrs', distance: '45 km' }] }]
  },
  experiences: [
    { title: 'Gupta Dynasty Sculpture & Temple Walk', duration: '3 hrs', price: '₹400', category: 'Heritage', image: 'https://images.unsplash.com/photo-1600100397608-f010e423b961?w=600&h=400&fit=crop&auto=format' }
  ],
  aiPrompts: [
    'Tell me the history of Dashavatara Temple Deogarh',
    'Best time to visit Rajghat Waterfall in Lalitpur',
    'How to reach Talbehat Fort from Lalitpur station?'
  ],
  reviews: [
    { name: 'Anurag Sharma', location: 'Bhopal', text: 'Deogarh temple carvings are mind-blowing! True hidden gem of UP.', rating: 5, image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&h=100&fit=crop&auto=format', date: 'Feb 2026' }
  ],
  sources: {
    official: ['UP Tourism Official Portal', 'ASI Deogarh Circle'],
    historical: ['Epigraphia Indica - Gupta Period', 'Bundelkhand Gazetteer'],
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={lalitpur} />
      <QuickFacts facts={lalitpur.quickFacts} />
      <WhyVisit destination={lalitpur} />
      <DestinationStory destination={lalitpur} />
      <HistoryTimeline destination={lalitpur} />
      <CultureGrid destination={lalitpur} />
      <FoodSection destination={lalitpur} />
      <AttractionsGrid destination={lalitpur} />
      <HiddenGems destination={lalitpur} />
      <ThingsToDo destination={lalitpur} />
      <NearbyPlaces destination={lalitpur} />
      <HowToReach destination={lalitpur} />
      <WhereToStay destination={lalitpur} />
      <BestTime destination={lalitpur} />
      <BudgetGuide destination={lalitpur} />
      <Itineraries destination={lalitpur} />
      <LocalExperiences destination={lalitpur} />
      <MapSection destination={lalitpur} />
      <AskD360 destination={lalitpur} />
      <CommunityStories destination={lalitpur} />
      <PracticalInfo />
      <SourcesTrust destination={lalitpur} />
      <Footer />
    </div>
  )
}
