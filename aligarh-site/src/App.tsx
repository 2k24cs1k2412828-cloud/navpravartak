...
const aligarh: Destination = {
  id: 'aligarh', slug: 'aligarh-uttar-pradesh', name: 'Aligarh', localName: 'अलीगढ़',
  destinationType: 'Lock City & Educational Hub', country: 'India', state: 'Uttar Pradesh', district: 'Aligarh',
  established: { year: '12th Century AD', by: 'Koil Kings (Ancient Fort)' },
  shortDescription: 'Famous for Aligarh Muslim University, historical Koil Fort, world-renowned Taala Nagri lock industry, and vibrant food culture.',
  tags: ['EDUCATIONAL', 'HERITAGE', 'MUGHLAI_FOOD', 'LOCK_CRAFT'],
  hero: {
  ...
  quickFacts: {
    ...
    destinationType: 'Heritage & University City', difficulty: 'Easy', distance: '~130 km from Delhi / 85 km Agra'
  },
  discoveryScore: {
    overall: 8.4,
    categories: [
      { name: 'Uniqueness', score: 8.8 },
      { name: 'Historical Significance', score: 9.1 },
      { name: 'Cultural Value', score: 8.9 },
      { name: 'Crowd Level', score: 7.2 },
      { name: 'Local Experience', score: 8.5 }
    ]
  },
  editorial: {
    why: 'Aligarh is the intellect and craftsmanship capital of Western UP. Home to Sir Syed\'s historic university (AMU), centuries-old Koil Fort, world-famous lock making artisans, and unmatched street food.',
    story: 'Originally known as Koil, Aligarh evolved from a strategic medieval fort town into a premier center of modern education and industrial craftsmanship during the 19th and 20th centuries.',
    storyFull: 'The campus of Aligarh Muslim University showcases breathtaking Indo-Saracenic architectural masterworks like Strachey Hall and the University Mosque. In old city mohallas, brass lock craftsmen still hand-assemble complex security mechanisms. Morning street stalls buzz with crispy Hing Kachori, while nights smell of slow-cooked Mughlai Nihari and Shami Kebabs.'
  },
  history: {
    shortIntro: 'From ancient Koil Fort to Sir Syed\'s educational renaissance and Taala Nagri industry.',
    timeline: [
      { year: '12th Century', event: 'Ancient Koil Fort established on strategic trade route connecting Delhi and Gangetic plains', era: 'Medieval Era' },
      { year: '1757 CE', event: 'Fort reinforced by Marathas and French officers, renamed Aligarh by Najaf Khan', era: 'Maratha & French Era' },
      { year: '1875 CE', event: 'Sir Syed Ahmad Khan establishes Muhammadan Anglo-Oriental (MAO) College', era: 'Educational Renaissance' },
      { year: '1920 CE', event: 'MAO College incorporated as Aligarh Muslim University (AMU) by Central Act', era: 'University Charter' },
      { year: '1960s', event: 'Aligarh becomes India\'s largest lock manufacturing hub, earning title "Taala Nagri"', era: 'Industrial Age' }
    ]
  },
  culture: [
    { title: 'Indo-Saracenic Architecture', description: 'AMU campus contains grand Victorian-Mughal revival buildings designed with red sandstone arches and clock towers.', image: 'https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=600&h=400&fit=crop&auto=format' },
    { title: 'Taala Nagri Lock Heritage', description: 'Over 150-year-old tradition of handcrafting high-security brass, iron, and antique decorative locks.', image: 'https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=600&h=400&fit=crop&auto=format' },
    { title: 'Literary & Urdu Heritage', description: 'Hub of Urdu poetry (Mushaira), classical literature, and historical archives at Sir Syed Academy.', image: 'https://images.unsplash.com/photo-1524613032530-449a5d94c285?w=600&h=400&fit=crop&auto=format' },
    { title: 'Old City Culinary Culture', description: 'Centuries-old breakfast traditions of Hing Kachori and night markets serving rich Mughlai stews.', image: 'https://images.unsplash.com/photo-1662101875545-0b0cb8b7795b?w=600&h=400&fit=crop&auto=format' }
  ],
  food: [
    { name: 'Aligarh ki Kachori', description: 'Distinctly crisp, hard, flaky kachoris served piping hot with spicy, thick potato curry heavily infused with aromatic hing (asafoetida).', category: 'Breakfast', price: '₹30–₹60', image: 'https://images.unsplash.com/photo-1552912470-ee2e96439539?w=500&h=360&fit=crop&auto=format' },
    { name: 'Shami Kebab', description: 'Melt-in-mouth kebabs crafted from finely minced meat and chana dal, bound with aromatic whole spices and pan-seared.', category: 'Street Food', price: '₹60–₹120', image: 'https://images.unsplash.com/photo-1662101875545-0b0cb8b7795b?w=500&h=360&fit=crop&auto=format' },
    { name: 'Gajak', description: 'Famous winter sweet prepared from toasted sesame seeds, pure jaggery, and ghee, renowned for wafer-thin crispiness.', category: 'Sweet', price: '₹200–₹350/kg', image: 'https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=500&h=360&fit=crop&auto=format' },
    { name: 'Nihari & Khamiri Roti', description: 'Slow-cooked stew simmered overnight with bone marrow and special spices, eaten with soft yeast-leavened khamiri roti.', category: 'Main Course', price: '₹120–₹220', image: 'https://images.unsplash.com/photo-1662101875545-0b0cb8b7795b?w=500&h=360&fit=crop&auto=format' }
  ],
  attractions: [
    { id: 'amu-campus', name: 'Aligarh Muslim University Campus', category: 'Educational Heritage', description: 'Sprawling 1,150-acre heritage campus featuring Strachey Hall, Victoria Gate, and the grand University Mosque.', duration: '3 hrs', distance: 'Central Aligarh', score: 9.6, image: 'https://upload.wikimedia.org/wikipedia/commons/2/24/AMU_Masjid_-_panoramio.jpg' },
    { id: 'aligarh-fort', name: 'Aligarh Fort (Koil Fort)', category: 'Historic Monument', description: 'Polyhedral medieval fort surrounded by a deep moat, built by French engineer Benoit de Boigne for Marathas.', duration: '1.5 hrs', distance: '3 km from center', score: 8.7, image: 'https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=600&h=420&fit=crop&auto=format' },
    { id: 'sir-syed-house', name: 'Sir Syed House & Museum', category: 'Museum & Heritage', description: 'Preserved residence of Sir Syed Ahmad Khan displaying personal belongings, letters, and history of modern Indian education.', duration: '1.5 hrs', distance: 'Inside AMU', score: 8.9, image: 'https://images.unsplash.com/photo-1524613032530-449a5d94c285?w=600&h=420&fit=crop&auto=format' },
    { id: 'mangalayatan', name: 'Teerthdham Mangalayatan', category: 'Spiritual Complex', description: 'Massive 13-acre Jain temple complex featuring grand marble temples, research institutes, and peaceful gardens.', duration: '2 hrs', distance: '13 km from town', score: 9.0, image: 'https://images.unsplash.com/photo-1616368309964-3a686de13b4d?w=600&h=420&fit=crop&auto=format' }
  ],
  hiddenGems: [
    { name: 'Old City Jama Masjid', why: '18th-century mosque built on the highest point of old city, featuring 17 domes and gold-plated spires.', distance: 'Old City Chowk', duration: '45 min', image: 'https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=800&h=500&fit=crop&auto=format' },
    { name: 'Shekha Jheel Bird Sanctuary', why: 'Natural freshwater wetland hosting thousands of migratory waterbirds during winter months.', distance: '17 km from city', duration: '2 hrs', image: 'https://images.unsplash.com/photo-1663089551295-cee8e58807a0?w=800&h=500&fit=crop&auto=format' }
  ],
  thingsToDo: [
    { activity: 'AMU Heritage Architecture Walk', duration: '2.5 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning', image: 'https://upload.wikimedia.org/wikipedia/commons/2/24/AMU_Masjid_-_panoramio.jpg' },
    { activity: 'Taala Nagri Artisan & Lock Market Tour', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Afternoon', image: 'https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=600&h=400&fit=crop&auto=format' },
    { activity: 'Old City Hing Kachori & Kebab Trail', duration: '2 hrs', cost: '₹200', difficulty: 'Easy', bestTime: '8:00 AM / 7:00 PM', image: 'https://images.unsplash.com/photo-1552912470-ee2e96439539?w=600&h=400&fit=crop&auto=format' }
  ],
  nearbyPlaces: [
    { name: 'Mathura & Vrindavan', distance: '65 km', type: 'Spiritual Sacred City', travelTime: '1.2 hrs', image: 'https://images.unsplash.com/photo-1524613032530-449a5d94c285?w=500&h=340&fit=crop&auto=format' },
    { name: 'Agra', distance: '85 km', type: 'UNESCO Taj City', travelTime: '1.5 hrs', image: 'https://images.unsplash.com/photo-1523428461295-92770e70d7ae?w=500&h=340&fit=crop&auto=format' },
    { name: 'Noida / Delhi', distance: '130 km', type: 'Metropolitan Hub', travelTime: '2 hrs', image: 'https://images.unsplash.com/photo-1663089551295-cee8e58807a0?w=500&h=340&fit=crop&auto=format' }
  ],
  travel: {
    air: { airport: 'Jewar Noida Intl (Upcoming) / Delhi (DEL)', distance: '60 km / 130 km', time: '1 hr / 2.5 hrs' },
    rail: { station: 'Aligarh Junction (ALJN)', distance: 'City center', time: 'Major junction on Delhi-Howrah main rail line' },
    road: { highway: 'Yamuna Expressway / NH-34', distance: 'Connected via Grand Trunk Road & Yamuna Expressway', time: '2 hrs from Delhi NCR' }
  },
  stay: {
    categories: [
      { type: 'Budget', range: '₹600–₹1,200/night', options: ['AMU Alumni Guest Houses', 'Hotel Ruby', 'Station Road Lodges'] },
      { type: 'Mid-Range', range: '₹1,800–₹3,500/night', options: ['Hotel Royal Residency', 'Hotel Melrose Inn', 'Lemon Tree Aligarh'] },
      { type: 'Luxury / Corporate', range: '₹4,000–₹8,000/night', options: ['The Ramada by Wyndham', 'Fortune Park Aligarh'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Traveller', perDay: '₹1,000–₹1,600', breakdown: [{ category: 'Stay', amount: '₹500–₹800' }, { category: 'Food', amount: '₹200–₹400' }, { category: 'Transport', amount: '₹150–₹250' }, { category: 'Entry Fees', amount: '₹50' }, { category: 'Activities', amount: '₹100' }] },
      { tier: 'Comfort', perDay: '₹2,200–₹4,000', breakdown: [{ category: 'Stay', amount: '₹1,500–₹2,500' }, { category: 'Food', amount: '₹400–₹700' }, { category: 'Transport', amount: '₹300–₹500' }, { category: 'Entry Fees', amount: '₹100' }, { category: 'Activities', amount: '₹200' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '8:00 AM', place: 'Breakfast — Aligarh Hing Kachori', duration: '45 min', distance: 'Old City' }, { time: '9:30 AM', place: 'AMU Campus & Strachey Hall Walk', duration: '3 hrs', distance: 'Central AMU' }, { time: '1:00 PM', place: 'Sir Syed Museum', duration: '1 hr', distance: 'Inside AMU' }, { time: '2:30 PM', place: 'Lunch — Shami Kebabs & Biryani', duration: '1 hr', distance: 'Civil Lines' }, { time: '4:00 PM', place: 'Taala Nagri Lock Craft Market', duration: '2 hrs', distance: 'Industrial Area' }, { time: '6:30 PM', place: 'Teerthdham Mangalayatan Temple Visit', duration: '1.5 hrs', distance: '13 km' }] }],
    '2 Days': [{ day: 1, schedule: [{ time: '9:00 AM', place: 'AMU Heritage Campus & University Mosque', duration: '3 hrs', distance: 'Central AMU' }, { time: '2:00 PM', place: 'Aligarh Fort (Koil Fort) Exploration', duration: '2 hrs', distance: '3 km' }, { time: '5:00 PM', place: 'Old City Jama Masjid & Gajak Shopping', duration: '2 hrs', distance: 'Old Chowk' }] }, { day: 2, schedule: [{ time: '7:30 AM', place: 'Shekha Jheel Bird Watching', duration: '2.5 hrs', distance: '17 km' }, { time: '11:00 AM', place: 'Teerthdham Mangalayatan Temple Complex', duration: '2 hrs', distance: '13 km' }, { time: '3:00 PM', place: 'Lock Factory Workshop & Shopping', duration: '2 hrs', distance: 'Taala Nagri' }] }]
  },
  experiences: [
    { title: 'AMU University Heritage & Sir Syed Library Tour', duration: '3 hrs', price: '₹300', category: 'Heritage', image: 'https://upload.wikimedia.org/wikipedia/commons/2/24/AMU_Masjid_-_panoramio.jpg' }
  ],
  aiPrompts: [
    'What is the history of Sir Syed Ahmad Khan and AMU in Aligarh?',
    'Where to eat the best Hing Kachori in Aligarh?',
    'How are handmade locks manufactured in Aligarh Taala Nagri?'
  ],
  reviews: [
    { name: 'Dr. Tariq Mansoor', location: 'Aligarh', text: 'The AMU campus architecture and old city kachoris make Aligarh truly unique!', rating: 5, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&auto=format', date: 'Jan 2026' }
  ],
  sources: {
    official: ['Aligarh District Portal', 'AMU Archives Office'],
    historical: ['Hayat-e-Javed', 'Aligarh Gazetteer 1909'],
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={aligarh} />
      <QuickFacts facts={aligarh.quickFacts} />
      <WhyVisit destination={aligarh} />
      <DestinationStory destination={aligarh} />
      <HistoryTimeline destination={aligarh} />
      <CultureGrid destination={aligarh} />
      <FoodSection destination={aligarh} />
      <AttractionsGrid destination={aligarh} />
      <HiddenGems destination={aligarh} />
      <ThingsToDo destination={aligarh} />
      <NearbyPlaces destination={aligarh} />
      <HowToReach destination={aligarh} />
      <WhereToStay destination={aligarh} />
      <BestTime destination={aligarh} />
      <BudgetGuide destination={aligarh} />
      <Itineraries destination={aligarh} />
      <LocalExperiences destination={aligarh} />
      <MapSection destination={aligarh} />
      <AskD360 destination={aligarh} />
      <CommunityStories destination={aligarh} />
      <PracticalInfo />
      <SourcesTrust destination={aligarh} />
      <Footer />
    </div>
  )
}
