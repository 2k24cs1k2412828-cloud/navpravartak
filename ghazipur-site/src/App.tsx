...
export const ghazipur: Destination = {
  id: "ghazipur",
  slug: "ghazipur-uttar-pradesh",
  name: "Ghazipur",
  localName: "गाज़ीपुर",
  destinationType: "Colonial & River Heritage City",
  country: "India",
  state: "Uttar Pradesh",
  district: "Ghazipur",
  shortDescription: "The Rose Garden City on the Ganges, Lord Cornwallis tomb, and Purvanchali food capital.",
  tags: ["COLONIAL HERITAGE", "RIVER GHATS", "CULINARY"],
  hero: {
    image: "/images/ghazipur_hero_fullhd.jpg",
    poster: "/images/river_aarti.jpg"
  },
  quickFacts: {
    bestTime: "Oct – Mar",
    duration: "1–2 Days",
    budget: "₹",
    destinationType: "Colonial & River City",
    difficulty: "Easy",
  ...
  discoveryScore: {
    ...
    categories: [
      ...
      { name: "Colonial Architecture", score: 9.1 },
      { name: "Culinary Heritage", score: 9.5 },
      { name: "River Experience", score: 8.8 },
      { name: "Uniqueness", score: 8.7 }
    ]
  },
  editorial: {
    why: "Historically celebrated as \"Gulab Nagri\" (City of Roses) for its legendary attar distilleries, Ghazipur sits regally on the holy Ganges. It is internationally renowned for housing the grand neoclassical rotunda tomb of British Governor-General Lord Cornwallis, the world's oldest continuously operating legal Opium Factory, and a deeply authentic culinary heritage.",
    story: "Established in 1330 AD, Ghazipur developed as an indispensable trading emporium along the strategic shipping lanes of the Ganges. In 1805, Lord Cornwallis, who had served as Governor-General of India and British General during the American Revolutionary War, passed away here while inspecting troops.",
    storyFull: 'The monumental domed mausoleum constructed in his honor stands surrounded by lush lawns overlooking the Ganges. Nearby stands the 200-year-old Government Opium and Alkaloid Factory, established by the East India Company in 1820. Yet Ghazipur\'s true soul is found in its vibrant street corners smelling of woodfire-roasted Litti Chokha, fragrant winter Nimona, and the delicate perfume of rose water stills.'
  },
  history: {
    shortIntro: "A storied river city of Mughal governors, British generals, and rose perfume.",
    timeline: [
      { year: "1330 AD", event: "Founded by Sayyid Masud Ghazipuri during the rule of Muhammad bin Tughlaq", era: "Sultanate Era" },
      { year: "1805", event: "Governor-General Lord Cornwallis dies in Ghazipur; construction begins on his Grecian dome tomb", era: "British Raj" },
      { year: "1820", event: "British East India Company opens the Government Opium Factory, operating uninterrupted to this day", era: "Colonial Industry" },
      { year: "1857", event: "Ghazipur emerges as an active stronghold during the Indian Rebellion of 1857", era: "Freedom Struggle" },
      { year: "1965", event: "Company Quartermaster Havildar Abdul Hamid of Ghazipur awarded Param Vir Chakra for heroism in Battle of Asal Uttar", era: "National Honor" }
    ]
  },
  culture: [
    {
      title: "Gulab Nagri (Rose Perfume)",
      description: "Generations of traditional perfumers steam-distill Damask rose petals in heritage copper cauldrons (degs) to produce pure Rooh Gulab and Gulab Jal.",
      image: 'https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=600&h=400&fit=crop&auto=format'
    },
    {
      title: "Ganges Riverfront Ghats",
      description: "Ancient bathing ghats like Collectorate Ghat and Cheet Nath Ghat serve as spiritual community hubs for morning yoga and evening chants.",
      image: '/images/river_aarti.jpg'
    },
    {
      title: "Purvanchali Culinary Ethos",
      description: "A culinary culture rooted in wood-fired earthen ovens, stone-ground spices, roasted sattu, and seasonal river fish.",
      image: 'https://images.unsplash.com/photo-1662101875545-0b0cb8b7795b?w=600&h=400&fit=crop&auto=format'
    },
    {
      title: "Heroic Military Legacy",
      description: "Home of celebrated war heroes and martyrs, including Param Vir Chakra Abdul Hamid and centuries of valiant soldiers.",
      image: 'https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=600&h=400&fit=crop&auto=format'
    }
  ],
  food: [
    {
      name: "Litti Chokha",
      description: "Purvanchal's crowning jewel: whole wheat dough balls stuffed with spiced roasted sattu, charred over dried cow-dung fire, smothered in hot ghee.",
    ...
    {
      name: "Dal Pithi",
      description: "Handcrafted floral wheat dumplings gently simmered in spiced yellow lentil stew with mustard seed and garlic tadka.",
      category: "Traditional",
      price: "₹60–₹100",
      image: '/images/dal_pithi.jpg'
    },
    {
      name: "Nimona (Winter Delight)",
      description: "Silky curry prepared from freshly crushed sweet winter green peas, seasoned with cumin, coriander, and fried urad dal vadis.",
      category: "Seasonal",
      price: "₹70–₹120",
      image: 'https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=500&h=360&fit=crop&auto=format'
    },
    {
      name: "Thekua",
      description: "Crisp, aromatic deep-fried biscuits made of coarse whole wheat flour, dark sugarcane jaggery, cardamom, and pure ghee.",
      category: "Sweet Snack",
      price: "₹150–₹250/kg",
      image: '/images/thekua.jpg'
    },
    {
      name: "Sattu Paratha & Ghughni",
      description: "Flaky griddled paratha stuffed with tangy sattu, served alongside a savory bowl of spiced black chickpea ghughni.",
      category: "Breakfast",
      price: "₹40–₹80",
      image: '/images/sattu_paratha.jpg'
    }
  ],
  attractions: [
    {
      ...
      category: "ASI Heritage Monument",
      description: "Grand 1805 neoclassical cylindrical rotunda supported by 12 Corinthian marble pillars, commemorating the British Governor-General.",
      duration: "1.5–2 hrs",
      distance: "City centre",
      score: 9.6,
      image: '/images/cornwallis_tomb.jpg'
    },
    {
      id: "ghazipur-ghat",
      name: "Ghazipur Ganges Ghats",
      category: "Historic Riverfront",
      description: "Peaceful stepped stone ghats on the broad bend of the Ganges, offering serene boat rides and unobstructed sunset vistas.",
      duration: "1.5 hrs",
      distance: "Riverfront",
      score: 9.0,
      image: '/images/river_aarti.jpg'
    ...
    {
      id: "opium-factory",
      name: "Historic Opium Factory & Heritage Museum",
      category: "Colonial Industrial Heritage",
      description: "Asia's oldest operating legal pharmaceutical opium alkaloid factory founded in 1820, featuring rare colonial architecture and records.",
      duration: "1.5 hrs",
      distance: "1.5 km from centre",
      score: 8.8,
      image: 'https://images.unsplash.com/photo-1524613032530-449a5d94c285?w=600&h=420&fit=crop&auto=format'
    },
    {
      id: "durgakund-ghazipur",
      name: "Durgakund & Temple Complex",
      category: "Spiritual Shrine",
      description: "Sacred water reservoir and temple dedicated to Goddess Durga, a focal point of festive Navratri celebrations.",
      duration: "1 hr",
    ...
    {
      id: "bhitari-pillar",
      name: "Bhitari Gupta Pillar (Saidpur)",
      category: "Archaeological Site",
      description: "Ancient 5th-century red sandstone monolith carrying Skandagupta's famous Sanskrit inscription recording victory over the Hunas.",
      duration: "2 hrs",
      distance: "32 km west towards Varanasi",
      score: 9.3,
  ...
  hiddenGems: [
    {
      name: "Heritage Rose Water Distilleries",
      why: "Wander through family-run perfumeries where century-old copper degs and bhabhkas distill organic rose water that once perfumed royal courts.",
      distance: "Old Ghazipur alleys",
      duration: "1 hr",
      image: 'https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=800&h=500&fit=crop&auto=format'
    },
    {
      name: "Cheet Nath Ghat Evening Chants",
      why: "An undiscovered ghat where local musicians gather with harmoniums and dholaks for soulful bhajans as the river glows red at dusk.",
      distance: "1 km from centre",
      duration: "1.5 hrs",
      image: 'https://images.unsplash.com/photo-1627894483216-2138af692e32?w=800&h=500&fit=crop&auto=format'
    }
  ],
  thingsToDo: [
    { activity: "Heritage Photography at Lord Cornwallis Tomb", duration: "2 hrs", cost: "Free", difficulty: "Easy", bestTime: "Golden Hour (4:30 PM)", image: "https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=600&h=400&fit=crop&auto=format" },
    { activity: "Authentic Litti Chokha Food Trail", duration: "2 hrs", cost: "₹200–₹400", difficulty: "Easy", bestTime: "1:00 PM or 7:00 PM", image: "https://images.unsplash.com/photo-1662101875545-0b0cb8b7795b?w=600&h=400&fit=crop&auto=format" },
    { activity: "Sunset Ganga Boat Ride", duration: "1.5 hrs", cost: "₹250–₹500", difficulty: "Easy", bestTime: "5:30 PM, Oct–Mar", image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?w=600&h=400&fit=crop&auto=format" },
    { activity: "Gupta Archaeology Excursion to Bhitari", duration: "3 hrs", cost: "₹500 (cab)", difficulty: "Easy", bestTime: "Morning", image: "https://images.unsplash.com/photo-1663089551295-cee8e58807a0?w=600&h=400&fit=crop&auto=format" }
  ],
  nearbyPlaces: [
    { name: "Varanasi", distance: "70 km", type: "Spiritual Capital", travelTime: "1.5 hrs", image: "https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=500&h=340&fit=crop&auto=format" },
    { name: "Sarnath", distance: "65 km", type: "Buddhist Heritage", travelTime: "1.5 hrs", image: "https://images.unsplash.com/photo-1609137144822-491c13d78905?w=500&h=340&fit=crop&auto=format" },
    { name: "Ballia", distance: "65 km", type: "Freedom Fighter Heritage", travelTime: "1.5 hrs", image: "https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=500&h=340&fit=crop&auto=format" },
    { name: "Chunar Fort", distance: "100 km", type: "Historic Fortress", travelTime: "2.5 hrs", image: "https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=500&h=340&fit=crop&auto=format" }
  ],
  travel: {
    air: { airport: "Lal Bahadur Shastri Airport, Varanasi (VNS)", distance: "75 km", time: "~1.5 hrs via NH-31" },
    rail: { station: "Ghazipur City Railway Station (GCT)", distance: "City centre", time: "Direct Express trains to New Delhi, Lucknow, Kolkata" },
    road: { highway: "Purvanchal Expressway & NH-31", distance: "70 km from Varanasi", time: "1.5 hrs by car / frequent state buses" }
  },
  stay: {
    categories: [
      { type: "Budget", range: "₹600–₹1,300/night", options: ["Hotel Prakash", "Hotel Royal Palace", "Ganges View Lodge"] },
      { type: "Mid-Range", range: "₹1,800–₹3,500/night", options: ["Hotel The Grand Ghazipur", "Hotel Relax Inn"] },
      { type: "Riverside Guesthouses", range: "₹900–₹2,000/night", options: ["Collectorate Ghat Homestays", "Local Heritage Stays"] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: "Budget Traveller", perDay: "₹900–₹1,600", breakdown: [{ category: "Stay", amount: "₹600–₹900" }, { category: "Food", amount: "₹200–₹400" }, { category: "Transport", amount: "₹100–₹300" }] },
      { tier: "Comfort", perDay: "₹2,200–₹4,500", breakdown: [{ category: "Stay", amount: "₹1,500–₹2,800" }, { category: "Food", amount: "₹400–₹900" }, { category: "Transport", amount: "₹300–₹800" }] }
    ]
  },
  itineraries: {
    '1 Day': [
      {
        day: 1,
        schedule: [
          { time: "8:00 AM", place: "Lord Cornwallis Tomb architecture tour", duration: "2 hrs", distance: "City centre" },
          { time: "10:30 AM", place: "Breakfast: Sattu Paratha with Ghughni", duration: "45 min", distance: "Old Bazaar" },
          { time: "11:45 AM", place: "Heritage Opium Factory & Museum archive", duration: "1.5 hrs", distance: "1.5 km" },
          { time: "1:30 PM", place: "Authentic woodfire Litti Chokha feast", duration: "1 hr", distance: "Civil lines" },
          { time: "3:30 PM", place: "Durgakund water temple visit", duration: "1 hr", distance: "3 km" },
          { time: "5:00 PM", place: "Sunset river walk & boat ride at Ghazipur Ghats", duration: "2 hrs", distance: "Ghats" },
          { time: "7:30 PM", place: "Traditional Rose Water (Gulab Jal) market trail", duration: "1 hr", distance: "Bazaar" }
        ]
      }
    ],
    '2 Days': [
      {
        day: 1,
        schedule: [
          { time: "8:30 AM", place: "Lord Cornwallis Neoclassical Memorial", duration: "2 hrs", distance: "Centre" },
          { time: "11:30 AM", place: "Opium Factory heritage walk", duration: "1.5 hrs", distance: "1.5 km" },
          { time: "3:30 PM", place: "Ghazipur Ganges Ghats boat ride and photography", duration: "2.5 hrs", distance: "Riverfront" },
          { time: "7:00 PM", place: "Purvanchali dinner: Nimona, Dal Pithi, Thekua", duration: "1.5 hrs", distance: "Town" }
        ]
      },
      {
        day: 2,
        schedule: [
          { time: "7:30 AM", place: "Excursion to 5th-century Gupta Inscription Pillar at Bhitari", duration: "3.5 hrs", distance: "32 km" },
          { time: "1:00 PM", place: "Return to Ghazipur for Litti Chokha lunch", duration: "1 hr", distance: "City" },
          { time: "3:00 PM", place: "Attar and Rose Water distillation workshop visit", duration: "2 hrs", distance: "Old city" },
          { time: "5:30 PM", place: "Evening tea and sweets by the Ganges", duration: "1.5 hrs", distance: "Collectorate Ghat" }
        ]
      }
    ]
  },
  experiences: [
    { title: "Cornwallis Tomb Architecture & History Walk", duration: "2 hrs", price: "₹350–₹700", category: "Heritage", image: "https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=600&h=400&fit=crop&auto=format" },
    { title: "Rose Water Distillation & Attar Trail", duration: "1.5 hrs", price: "₹400", category: "Craft", image: "https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=600&h=400&fit=crop&auto=format" },
    { title: "Authentic Purvanchali Litti Cooking Experience", duration: "2 hrs", price: "₹500", category: "Culinary", image: "https://images.unsplash.com/photo-1662101875545-0b0cb8b7795b?w=600&h=400&fit=crop&auto=format" }
  ],
  aiPrompts: [
    "Why is Lord Cornwallis buried in Ghazipur?",
    "Can tourists visit the Ghazipur Opium Factory?",
    "Best place for authentic Litti Chokha in Ghazipur?",
    'How to visit Bhitari Gupta pillar from Ghazipur?'
  ],
  reviews: [
    { name: "Dr. Alok Rai", location: "Prayagraj", text: "The Lord Cornwallis memorial is breathtaking—magnificent Grecian architecture right on the banks of the Ganges that very few tourists know about.", rating: 5, image: "https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=80&h=80&fit=crop&auto=format", date: "January 2026" },
    { name: "Claire Jenkins", location: "Bristol, UK", text: "Fascinating British-Indian colonial history and the friendliest locals. The Litti Chokha with smoked brinjal here is the best food in UP.", rating: 5, image: "https://images.unsplash.com/photo-1663089551295-cee8e58807a0?w=80&h=80&fit=crop&auto=format", date: "December 2025" }
  ],
  sources: {
    official: ["Archaeological Survey of India (asi.nic.in)", "Uttar Pradesh Tourism (uptourism.gov.in)", "Ghazipur District Portal (ghazipur.nic.in)"],
    historical: ["The Despatches, Minutes and Correspondence of the Marquess Wellesley", "Imperial Gazetteer of India — Ghazipur District"],
...
export default function App() {
  const destination: Destination = ghazipur
