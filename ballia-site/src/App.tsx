...
export const ballia: Destination = {
  id: "ballia",
  slug: "ballia-uttar-pradesh",
  name: "Ballia",
  localName: "बलिया",
  destinationType: "Revolutionary & Heritage City",
  country: "India",
  state: "Uttar Pradesh",
  district: "Ballia",
  shortDescription: "Land of Sage Bhrigu and the fierce revolutionary spirit of Baghi Ballia.",
  tags: ["REVOLUTIONARY", "RIVER HERITAGE", "SPIRITUAL"],
  hero: {
    image: "/images/ballia_hero_fullhd.jpg",
  ...
  quickFacts: {
    ...
    duration: "1–2 Days",
    budget: "₹",
    destinationType: "Revolutionary Heritage",
    difficulty: "Easy",
  ...
  discoveryScore: {
    overall: 8.5,
    categories: [
      { name: "Historical Significance", score: 9.7 },
      { name: "Cultural Value", score: 8.9 },
      { name: "Local Experience", score: 9.1 },
      { name: "Uniqueness", score: 8.6 },
      { name: "Crowd Level", score: 5.2 }
    ]
  },
  editorial: {
    why: "Known across India as \"Baghi Ballia\" (Rebel Ballia), this easternmost district of Uttar Pradesh holds an unmatched legacy of freedom struggle, Vedic philosophy of Sage Bhrigu, and rustic Purvanchali river culture along the sacred confluence of the Ganges and Ghaghara.",
    story: "Ballia is where independence was declared years before 1947. In August 1942 during the Quit India Movement, local freedom fighters led by Chittu Pandey overthrew British colonial rule for two weeks, forming one of India's first self-declared independent governments.",
    storyFull: 'Beyond its legendary revolutionary fire, Ballia traces its roots to antiquity. Sage Bhrigu, author of the celebrated astrological treatise Bhrigu Samhita, established his hermitage here at the sacred river confluence. Every autumn, millions gather for the Dadri Mela, the second largest cattle and cultural fair in India. The air smells of slow-cooked ghee and jaggery, while the tranquil waters of Surha Tal shelter thousands of migratory birds arriving from across the Himalayas.'
  },
  history: {
    shortIntro: "A sacred land of ancient sages and fearless freedom fighters.",
    timeline: [
      { year: "Vedic Era", event: "Sage Bhrigu performs deep penance and pens the Bhrigu Samhita near the Ganga-Ghaghara confluence", era: "Ancient Era" },
      { year: "1857", event: "Mangal Pandey, born in Nagwa (Ballia), fires the first bullet of India's First War of Independence", era: "Colonial Era" },
      { year: "1879", event: "Ballia is officially carved out and established as an independent district of Uttar Pradesh", era: "District Formation" },
      { year: "1942", event: "Chittu Pandey leads Quit India revolt; Ballia becomes free from British rule for 14 historic days", era: "Freedom Struggle" },
      { year: "1991", event: "Surha Tal sanctuary recognized as Jai Prakash Narayan Bird Sanctuary", era: "Contemporary Era" }
    ]
  },
  culture: [
    {
      title: "Baghi Ballia Heritage",
      description: "The spirit of defiance and national sacrifice is woven into local folklore, poetry, and memorials across the district honoring martyrs.",
      image: 'https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=600&h=400&fit=crop&auto=format'
    },
    {
      title: "Dadri Mela Fair",
      description: "Held on Kartik Purnima, Dadri Mela is the second largest cattle fair in India with camel races, rural handicrafts, and folk theater.",
      image: 'https://images.unsplash.com/photo-1524613032530-449a5d94c285?w=600&h=400&fit=crop&auto=format'
    },
    {
      title: "Bhojpuri Folk & Birha",
      description: "Soulful Bhojpuri music traditions, Kajari songs during monsoons, and lively Birha performances celebrate river life and valor.",
      image: 'https://images.unsplash.com/photo-1663089551295-cee8e58807a0?w=600&h=400&fit=crop&auto=format'
    },
    {
      title: "Sacred River Confluence",
      description: "The confluence of Mother Ganga and Ghaghara (Saryu) defines local spiritual life, dawn boat rituals, and sacred holy baths.",
  ...
  food: [
    {
      name: "Launglata",
      description: "Ballia's signature sweet. Crisp pastry sealed with a whole clove, stuffed with khoya and cardamom, steeped in warm sugar syrup.",
      category: "Dessert",
      price: "₹30–₹50/piece",
      image: '/images/launglata.jpg'
    },
    {
      name: "Litti Chokha",
      description: "Authentic Purvanchali roasted wheat dough balls stuffed with spiced sattu, served with smoked aubergine-tomato chokha and desi ghee.",
    ...
    {
      name: "Badi Poori",
      description: "Fluffy pooris served with spiced urad dal vadis in a rich, tangy potato curry—a classic local morning staple.",
      category: "Breakfast",
      price: "₹40–₹70",
    ...
    {
      name: "Sattu ki Lassi",
      description: "A deeply refreshing rustic drink made from roasted gram flour, cold churned yogurt, roasted cumin, black salt, and fresh mint.",
      category: "Beverage",
      price: "₹25–₹50",
    ...
    {
      name: "Gulab Sakri",
      description: "An artisanal regional fudge confection delicately scented with rose water and topped with slivered pistachios.",
      category: "Sweet",
      price: "₹200–₹400/kg",
      image: '/images/gorakhpur_peda.jpg'
    }
  ],
  attractions: [
    {
      ...
      description: "Ancient hermitage complex where Sage Bhrigu compiled the Bhrigu Samhita and Sage Dardar initiated the Dadri Mela.",
      duration: "1.5–2 hrs",
      distance: "2 km from town centre",
      score: 9.3,
    ...
    },
    {
      ...
      description: "Monumental memorial erected in memory of revolutionary freedom fighters of the 1942 Quit India Movement.",
      duration: "1 hr",
    ...
    },
    {
      ...
      category: "Ecotourism & Lake",
      description: "Sprawling 34 sq km natural oval lake hosting over 10,000 migratory Siberian birds, migratory cranes, and tranquil wetlands.",
      duration: "2–3 hrs",
      distance: "17 km north of Ballia",
      score: 9.1,
      image: '/images/surha_tal.jpg'
    },
    {
      id: "sangam-ghat",
      name: "Sangam Ghat (Ganga-Ghaghara)",
      category: "River Confluence",
      description: "Scenic point where the Holy Ganges meets the Ghaghara, providing panoramic river views and sunset boat rides.",
      duration: "1.5 hrs",
    ...
    },
    {
      ...
      description: "Historic village at the tri-junction of UP and Bihar, the revered birthplace of Loknayak Jayaprakash Narayan.",
      duration: "2 hrs",
      distance: "30 km east",
      score: 8.4,
  ...
  hiddenGems: [
    {
      name: "Janglee Baba Mandir",
      why: "A tranquil rustic temple secluded amidst lush village groves, where pilgrims seek serene spiritual meditation away from city rush.",
    ...
    {
      name: "Dardar Kshetra River Islands",
      why: "Seasonal sandy river islands forming after monsoons, offering golden sunrise vistas over the Ganges.",
      distance: "8 km along the river",
      duration: "1 hr",
      image: 'https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=800&h=500&fit=crop&auto=format'
    }
  ],
  thingsToDo: [
    { activity: "Sunrise Boat Ride on the Ganges", duration: "2 hrs", cost: "₹300–₹600", difficulty: "Easy", bestTime: "6:00 AM, Oct–Mar", image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?w=600&h=400&fit=crop&auto=format" },
    { activity: "Bird Watching at Surha Tal", duration: "3 hrs", cost: "₹200–₹500", difficulty: "Easy", bestTime: "Early morning, Nov–Feb", image: "https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=600&h=400&fit=crop&auto=format" },
    { activity: "Heritage Walk at Bhrigu Ashram", duration: "1.5 hrs", cost: "Free", difficulty: "Easy", bestTime: "Morning or Sunset", image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?w=600&h=400&fit=crop&auto=format" },
    { activity: "Launglata & Street Food Trail", duration: "2 hrs", cost: "₹150–₹350", difficulty: "Easy", bestTime: "Evening 5–8 PM", image: "https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=600&h=400&fit=crop&auto=format" }
  ],
  nearbyPlaces: [
    { name: "Varanasi (Kashi)", distance: "140 km", type: "Spiritual City", travelTime: "3.5 hrs", image: "https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=500&h=340&fit=crop&auto=format" },
    { name: "Ghazipur", distance: "65 km", type: "Colonial & River Heritage", travelTime: "1.5 hrs", image: "https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=500&h=340&fit=crop&auto=format" },
    { name: "Buxar (Bihar)", distance: "35 km", type: "Historical Battlefield", travelTime: "45 min", image: "https://images.unsplash.com/photo-1663089551295-cee8e58807a0?w=500&h=340&fit=crop&auto=format" },
    { name: "Gorakhpur", distance: "135 km", type: "Spiritual Center", travelTime: "3 hrs", image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?w=500&h=340&fit=crop&auto=format" }
  ],
  travel: {
    air: { airport: "Varanasi Airport (VNS)", distance: "145 km", time: "~3.5 hrs by taxi" },
    rail: { station: "Ballia Railway Station (BUI)", distance: "City centre", time: "Direct trains to Delhi, Varanasi, Kolkata, Lucknow" },
    road: { highway: "NH-31 & Purvanchal Expressway Link", distance: "140 km from Varanasi", time: "3.5 hrs by bus/car" }
  },
  stay: {
    categories: [
      { type: "Budget", range: "₹500–₹1,200/night", options: ["Hotel Sagar", "Hotel Grand Yash", "Station Road Guesthouses"] },
      { type: "Mid-Range", range: "₹1,500–₹3,500/night", options: ["Hotel Park Inn Ballia", "Hotel Classic", "Ganga View Tourist Lodge"] },
      { type: "Homestay", range: "₹800–₹1,800/night", options: ["Rural Homestays near Surha Tal", "Local Purvanchal Farm Stays"] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: "Backpacker", perDay: "₹800–₹1,500", breakdown: [{ category: "Stay", amount: "₹500–₹800" }, { category: "Food", amount: "₹200–₹350" }, { category: "Local Transport", amount: "₹100–₹250" }] },
      { tier: "Comfort", perDay: "₹2,000–₹4,000", breakdown: [{ category: "Stay", amount: "₹1,500–₹2,500" }, { category: "Food", amount: "₹400–₹800" }, { category: "Transport", amount: "₹300–₹600" }] }
    ]
  },
  itineraries: {
    '1 Day': [
      {
        day: 1,
        schedule: [
          { time: "6:30 AM", place: "Morning Darshan at Bhrigu Ashram", duration: "1.5 hrs", distance: "City centre" },
          { time: "8:30 AM", place: "Breakfast: Badi Poori & Sattu Drink", duration: "45 min", distance: "Station road" },
          { time: "10:00 AM", place: "Shaheed Smarak & Freedom Struggle Museum", duration: "1.5 hrs", distance: "2 km" },
          { time: "1:00 PM", place: "Authentic Litti Chokha Lunch", duration: "1 hr", distance: "Chowk" },
          { time: "3:30 PM", place: "Surha Tal Lake & Bird Sanctuary Sunset", duration: "2.5 hrs", distance: "17 km" },
          { time: "7:00 PM", place: "Evening Walk & Fresh Launglata sweet tasting", duration: "1 hr", distance: "Main market" }
        ]
      }
    ],
    '2 Days': [
      {
        day: 1,
        schedule: [
          { time: "7:00 AM", place: "Bhrigu Hermitage & Vedic Garden", duration: "2 hrs", distance: "City" },
          { time: "10:00 AM", place: "Shaheed Smarak Memorial", duration: "1.5 hrs", distance: "Centre" },
          { time: "3:30 PM", place: "Surha Tal boating and bird photography", duration: "3 hrs", distance: "17 km" },
          { time: "7:30 PM", place: "Dinner and folk music discussion", duration: "1.5 hrs", distance: "Hotel" }
        ]
      },
      {
        day: 2,
        schedule: [
          { time: "6:00 AM", place: "Sangam Ghat Sunrise boat ride", duration: "2.5 hrs", distance: "15 km" },
          { time: "10:00 AM", place: "Heritage excursion to Sitab Diara (JP Narayan birthplace)", duration: "3 hrs", distance: "30 km" },
          { time: "3:00 PM", place: "Janglee Baba Mandir forest visit", duration: "1.5 hrs", distance: "12 km" },
          { time: "6:00 PM", place: "Handicraft & Launglata sweets shopping", duration: "1.5 hrs", distance: "Bazaar" }
        ]
      }
    ]
  },
  experiences: [
    { title: "Surha Tal Migratory Bird Trail", duration: "3 hrs", price: "₹400–₹800", category: "Ecotourism", image: "https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=600&h=400&fit=crop&auto=format" },
    { title: "Baghi Ballia Freedom Heritage Walk", duration: "2 hrs", price: "₹300–₹600", category: "History", image: "https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=600&h=400&fit=crop&auto=format" },
    { title: "Traditional Launglata Sweet Workshop", duration: "1.5 hrs", price: "₹350", category: "Culinary", image: "https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=600&h=400&fit=crop&auto=format" }
  ],
  aiPrompts: [
    "Why is Ballia called Baghi Ballia?",
    "Best time to spot Siberian birds at Surha Tal?",
    "Where to eat the most authentic Launglata in Ballia?",
    'Plan a 1-day spiritual and freedom fighter tour'
  ],
  reviews: [
    { name: "Raghvendra Singh", location: "Varanasi", text: "Surha Tal in December is an undiscovered wonder. Thousands of migratory birds across the misty water without any commercial crowds.", rating: 5, image: "https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=80&h=80&fit=crop&auto=format", date: "January 2026" },
    { name: "Kavita Verma", location: "Lucknow", text: "Bhrigu Ashram has an incredible peaceful aura. And Ballia's fresh Launglata dipped warm in syrup is unforgettable.", rating: 5, image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?w=80&h=80&fit=crop&auto=format", date: "December 2025" }
  ],
  sources: {
    official: ["Uttar Pradesh Tourism (uptourism.gov.in)", "District Administration Ballia (ballia.nic.in)"],
    historical: ["History of the Indian Freedom Movement — Bipin Chandra", "Bhrigu Samhita — Vedic Heritage Series"],
...
export default function App() {
  const destination: Destination = ballia
