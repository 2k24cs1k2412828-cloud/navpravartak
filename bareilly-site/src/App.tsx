...
const bareilly: Destination = {
  id: 'bareilly', slug: 'bareilly-uttar-pradesh', name: 'Bareilly', localName: 'बरेली',
  destinationType: 'Nath Nagri & Furniture Capital', country: 'India', state: 'Uttar Pradesh', district: 'Bareilly',
  established: { year: '1537 AD', by: 'Jagat Singh Katehriya' },
  shortDescription: 'Famous as Nath Nagri for 7 ancient Shiva temples, ancient Panchala capital Ahichchhatra, Zari-Zardozi embroidery, and mouthwatering kebabs.',
  tags: ['SPIRITUAL', 'NATH_NAGRI', 'FURNITURE_CRAFT', 'FOOD'],
  hero: {
    image: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=1920&h=1080&fit=crop&auto=format',
    poster: 'https://images.unsplash.com/photo-1524613032530-449a5d94c285?w=1920&h=1080&fit=crop&auto=format'
  },
  quickFacts: {
    bestTime: 'Oct – Mar', duration: '2 Days', budget: '₹',
    destinationType: 'Pilgrimage & Heritage City', difficulty: 'Easy', distance: '~250 km from Delhi / 240 km Lucknow'
  },
  discoveryScore: {
    overall: 8.5,
    categories: [
      { name: 'Uniqueness', score: 8.7 },
      { name: 'Historical Significance', score: 9.0 },
      { name: 'Cultural Value', score: 8.8 },
      { name: 'Crowd Level', score: 6.8 },
      { name: 'Local Experience', score: 8.9 }
    ]
  },
  editorial: {
    why: 'Bareilly is the sacred Nath Nagri surrounded by seven ancient Shiva temples and the historic cradle of Northern Panchala Kingdom at Ahichchhatra. Celebrated worldwide for Zari-Zardozi craft, cane furniture, and delicious street food.',
    story: 'From the Mahabharata era capital of Panchala to the 18th-century Rohilla Afghan stronghold, Bareilly balances deep mythological roots with vibrant modern craft and food traditions.',
    storyFull: 'Seven ancient temples dedicated to Lord Shiva (including Alakhnath, Trivatinath, and Madhinath) form a protective spiritual ring around Bareilly, earning it the title Nath Nagri. Nearby Ahichchhatra ruins reveal 4,000-year-old brick stupas and fort walls. In busy bazaars, master embroiderers weave gold Zari thread onto silks, while street vendors serve smoky charcoal Seekh Kebabs and signature Swal Aloo breakfast.'
  },
  history: {
    shortIntro: 'Capital of ancient Panchala Kingdom and Rohilla chieftains, guarded by 7 sacred Shiva shrines.',
    timeline: [
      { year: '2500 BCE', event: 'Ahichchhatra (near Bareilly) becomes capital of Northern Panchala Kingdom mentioned in Mahabharata', era: 'Mahabharata Era' },
      { year: '1537 CE', event: 'Jagat Singh Katehriya establishes modern city of Bareilly named after his sons Bansdeo and Bareldeo', era: 'Medieval Foundation' },
      { year: '1774 CE', event: 'Rohilla Afghan chieftains fortify Rohilkhand region centered at Bareilly', era: 'Rohilla Era' },
      { year: '1857 CE', event: 'Khan Bahadur Khan proclaims independence from British rule in Bareilly during 1857 Rebellion', era: 'Freedom Movement' },
      { year: 'Modern Era', event: 'Bareilly develops into India\'s top Zari-Zardozi embroidery and furniture export hub', era: 'Craft & Industrial Age' }
    ]
  },
  culture: [
    { title: 'Nath Nagri Shiva Circuit', description: 'Seven historic Shiva temples positioned at seven cardinal points protecting the city from ancient times.', image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=600&h=400&fit=crop&auto=format' },
    { title: 'Zari-Zardozi Embroidery', description: 'GI-tagged handicraft tradition of embroidering intricate gold & silver metallic threads on heavy fabrics.', image: 'https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=600&h=400&fit=crop&auto=format' },
    { title: 'Wooden & Cane Furniture', description: 'Nationally famous furniture crafting industry using seasoned teak, sheesham, and woven cane.', image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=600&h=400&fit=crop&auto=format' },
    { title: 'Rohilkhand Street Food', description: 'Famous charcoal-grilled Seekh Kebabs, overnight Nihari, crispy Swal Aloo, and Kulfi Falooda.', image: 'https://images.unsplash.com/photo-1662101875545-0b0cb8b7795b?w=600&h=400&fit=crop&auto=format' }
  ],
  food: [
    { name: 'Bareilly Seekh Kebab', description: 'Minced mutton or chicken expertly seasoned with secret Rohilkhand masalas, skewered on iron rods and grilled over live charcoal coals.', category: 'Street Food', price: '₹70–₹140', image: 'https://images.unsplash.com/photo-1662101875545-0b0cb8b7795b?w=500&h=360&fit=crop&auto=format' },
    { name: 'Swal Aloo', description: 'Bareilly\'s signature breakfast dish featuring crispy fried triangular flour crisps (swal) served with spicy dry potato gravy.', category: 'Breakfast', price: '₹30–₹50', image: 'https://images.unsplash.com/photo-1552912470-ee2e96439539?w=500&h=360&fit=crop&auto=format' },
    { name: 'Slow-Cooked Nihari', description: 'Rich mutton stew simmered overnight in copper cauldrons with aromatic herbs, served hot for breakfast with naan.', category: 'Main Course', price: '₹130–₹220', image: 'https://images.unsplash.com/photo-1662101875545-0b0cb8b7795b?w=500&h=360&fit=crop&auto=format' },
    { name: 'Kulfi Falooda', description: 'Dense, creamy cardamom kulfi served over silky vermicelli falooda noodles, basil seeds, and fragrant rose syrup.', category: 'Dessert', price: '₹50–₹90', image: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&h=360&fit=crop&auto=format' }
  ],
  attractions: [
    { id: 'alakhnath-temple', name: 'Alakhnath Temple', category: 'Nath Shrine', description: 'Headquarters of the Anand Akhara sadhus, an ancient Shiva temple complex housing sacred cows, peacocks, and shrines.', duration: '1.5 hrs', distance: '3 km from city center', score: 9.4, image: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=600&h=420&fit=crop&auto=format' },
    { id: 'trivatinath-temple', name: 'Trivati Nath Temple', category: 'Nath Shrine', description: 'Historic 15th-century Shiva temple situated under three ancient banyan (Vata) trees in central Bareilly.', duration: '1 hr', distance: 'City center', score: 9.1, image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=600&h=420&fit=crop&auto=format' },
    { id: 'ahichchhatra', name: 'Ahichchhatra Archaeological Ruins (Ramnagar)', category: 'Panchala Kingdom', description: 'Massive 4,000-year-old archaeological site featuring ancient brick fort walls, Buddhist stupa mounds, and Gupta temples.', duration: '3 hrs', distance: '50 km from Bareilly', score: 9.5, image: 'https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=600&h=420&fit=crop&auto=format' },
    { id: 'fun-city', name: 'Fun City Amusement & Water Park', category: 'Entertainment', description: 'Popular modern amusement park featuring water slides, roller coasters, and family recreation zones.', duration: '3 hrs', distance: '8 km from city', score: 8.3, image: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=600&h=420&fit=crop&auto=format' }
  ],
  hiddenGems: [
    { name: 'Chhoti Vamdev Temple', why: 'Quiet ancient Shiva temple nestled in old city lanes with intricate stone carving and serene meditation courtyard.', distance: 'Old City Chowk', duration: '45 min', image: 'https://images.unsplash.com/photo-1544717305-2782549b5136?w=800&h=500&fit=crop&auto=format' },
    { name: 'Zari Embroidery Artisans Colony (Shamat Ganj)', why: 'Living workshop quarters where generations of artisans weave real gold & silver thread onto ceremonial bridal wear.', distance: '2 km from center', duration: '1.5 hrs', image: 'https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=800&h=500&fit=crop&auto=format' }
  ],
  thingsToDo: [
    { activity: 'Nath Nagri 7-Shiva Temples Pilgrimage Trail', duration: '4 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Early Morning', image: 'https://images.unsplash.com/photo-1609137144813-7d9921338f24?w=600&h=400&fit=crop&auto=format' },
    { activity: 'Zari-Zardozi Embroidery Workshop Tour', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Afternoon', image: 'https://images.unsplash.com/photo-1728364283053-b1e2abe71611?w=600&h=400&fit=crop&auto=format' },
    { activity: 'Bareilly Charcoal Seekh Kebab Food Crawl', duration: '2 hrs', cost: '₹250', difficulty: 'Easy', bestTime: '7:00 PM', image: 'https://images.unsplash.com/photo-1662101875545-0b0cb8b7795b?w=600&h=400&fit=crop&auto=format' }
  ],
  nearbyPlaces: [
    { name: 'Pilibhit Tiger Reserve', distance: '65 km', type: 'Wildlife & Tigers', travelTime: '1.5 hrs', image: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=500&h=340&fit=crop&auto=format' },
    { name: 'Nainital (Uttarakhand)', distance: '140 km', type: 'Himalayan Hill Station', travelTime: '3.5 hrs', image: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=500&h=340&fit=crop&auto=format' },
    { name: 'Corbett National Park', distance: '150 km', type: 'Wildlife Safari', travelTime: '3.5 hrs', image: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=500&h=340&fit=crop&auto=format' }
  ],
  travel: {
    air: { airport: 'Bareilly Airport (BEK)', distance: '10 km', time: '20 min from city center' },
    rail: { station: 'Bareilly Junction (BE)', distance: 'City center', time: 'Major junction connecting Delhi, Lucknow, Kolkata, Dehradun' },
    road: { highway: 'NH-30 (Delhi-Lucknow Highway)', distance: 'Directly on NH-30', time: '4.5 hrs from Delhi by car' }
  },
  stay: {
    categories: [
      { type: 'Budget', range: '₹600–₹1,200/night', options: ['Hotel Oberoi', 'Station Road Lodges', 'UP Tourism Rahi Hotel'] },
      { type: 'Mid-Range', range: '₹1,800–₹3,500/night', options: ['Hotel Clarks Inn Bareilly', 'Hotel Diplomat Residency', 'The Manor Bareilly'] },
      { type: 'Luxury', range: '₹4,000–₹7,000/night', options: ['Radisson Hotel Bareilly Airport', 'Amaya Hotel'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Traveller', perDay: '₹1,100–₹1,700', breakdown: [{ category: 'Stay', amount: '₹500–₹800' }, { category: 'Food', amount: '₹250–₹400' }, { category: 'Transport', amount: '₹150–₹250' }, { category: 'Entry Fees', amount: '₹50' }, { category: 'Activities', amount: '₹150' }] },
      { tier: 'Comfort', perDay: '₹2,500–₹4,200', breakdown: [{ category: 'Stay', amount: '₹1,500–₹2,500' }, { category: 'Food', amount: '₹450–₹750' }, { category: 'Transport', amount: '₹350–₹600' }, { category: 'Entry Fees', amount: '₹100' }, { category: 'Activities', amount: '₹250' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '8:00 AM', place: 'Breakfast — Swal Aloo at Old City', duration: '45 min', distance: 'Old City' }, { time: '9:15 AM', place: 'Alakhnath Temple & Trivatinath Temple', duration: '2.5 hrs', distance: 'City center' }, { time: '12:30 PM', place: 'Zari-Zardozi Artisan Colony Visit', duration: '1.5 hrs', distance: 'Shamat Ganj' }, { time: '2:30 PM', place: 'Lunch — Bareilly Mutton Nihari', duration: '1 hr', distance: 'City center' }, { time: '4:00 PM', place: 'Cane & Wooden Furniture Market', duration: '2 hrs', distance: 'Civil Lines' }, { time: '6:30 PM', place: 'Evening Charcoal Seekh Kebab Trail', duration: '1.5 hrs', distance: 'Old City' }] }],
    '2 Days': [{ day: 1, schedule: [{ time: '9:00 AM', place: 'Nath Nagri 7-Shiva Temple Trail', duration: '3.5 hrs', distance: 'Across Bareilly' }, { time: '2:00 PM', place: 'Zari Embroidery Workshops', duration: '2 hrs', distance: 'Shamat Ganj' }, { time: '5:00 PM', place: 'Kulfi Falooda & Night Street Food', duration: '2 hrs', distance: 'City Chowk' }] }, { day: 2, schedule: [{ time: '8:30 AM', place: 'Drive to Ahichchhatra Panchala Ruins', duration: '1.2 hrs', distance: '50 km' }, { time: '10:00 AM', place: 'Ahichchhatra Stupa & Ancient Fort Exploration', duration: '3 hrs', distance: 'Ramnagar' }, { time: '3:00 PM', place: 'Return & Visit Furniture Markets', duration: '2 hrs', distance: 'Bareilly City' }] }]
  },
  experiences: [
    { title: 'Nath Nagri Sacred Temples & Zari Embroidery Heritage', duration: '3 hrs', price: '₹350', category: 'Heritage', image: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=800&h=500&fit=crop&auto=format' }
  ],
  aiPrompts: [
    'Why is Bareilly known as Nath Nagri?',
    'What is the history of ancient Ahichchhatra near Bareilly?',
    'Where can I find authentic Zari-Zardozi embroidery in Bareilly?'
  ],
  reviews: [
    { name: 'Sanjay Gangwar', location: 'Bareilly', text: 'Bareilly Seekh Kebabs and Alakhnath temple make my hometown super special!', rating: 5, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&auto=format', date: 'Feb 2026' }
  ],
  sources: {
    official: ['Bareilly District Administration', 'ASI Agra Circle (Ahichchhatra)'],
    historical: ['Mahabharata Panchala History', 'Rohilkhand Gazetteer'],
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={bareilly} />
      <QuickFacts facts={bareilly.quickFacts} />
      <WhyVisit destination={bareilly} />
      <DestinationStory destination={bareilly} />
      <HistoryTimeline destination={bareilly} />
      <CultureGrid destination={bareilly} />
      <FoodSection destination={bareilly} />
      <AttractionsGrid destination={bareilly} />
      <HiddenGems destination={bareilly} />
      <ThingsToDo destination={bareilly} />
      <NearbyPlaces destination={bareilly} />
      <HowToReach destination={bareilly} />
      <WhereToStay destination={bareilly} />
      <BestTime destination={bareilly} />
      <BudgetGuide destination={bareilly} />
      <Itineraries destination={bareilly} />
      <LocalExperiences destination={bareilly} />
      <MapSection destination={bareilly} />
      <AskD360 destination={bareilly} />
      <CommunityStories destination={bareilly} />
      <PracticalInfo />
      <SourcesTrust destination={bareilly} />
      <Footer />
    </div>
  )
}
