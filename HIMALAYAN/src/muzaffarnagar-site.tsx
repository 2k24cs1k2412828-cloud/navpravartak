...
export const muzaffarnagar: Destination = {
  id: "muzaffarnagar",
  slug: "muzaffarnagar-uttar-pradesh",
  name: "Muzaffarnagar",
  localName: "मुज़फ़्फ़रनगर",
  destinationType: "Sugarcane Hub & Sacred Pilgrimage Gateway",
  country: "India",
  state: "Uttar Pradesh",
  district: "Muzaffarnagar",
  shortDescription: "Major sugarcane and jaggery production hub of North India, known as the Sugar Bowl of India.",
  tags: ["SUGAR BOWL OF INDIA", "PILGRIMAGE GATEWAY", "HERITAGE"],
  hero: {
    image: "https://d3sftlgbtusmnv.cloudfront.net/blog/wp-content/uploads/2024/12/Akshay-Vat-Vatika.jpg",
    poster: "https://d3sftlgbtusmnv.cloudfront.net/blog/wp-content/uploads/2024/12/Akshay-Vat-Vatika.jpg"
  },
  quickFacts: {
    bestTime: "Oct – Mar",
    duration: "1–2 Days",
    budget: "₹₹",
    destinationType: "Agricultural & Spiritual Hub",
    difficulty: "Easy",
  ...
  discoveryScore: {
    overall: 8.5,
    categories: [
      { name: "Agricultural Heritage", score: 9.6 },
      { name: "Spiritual Prominence", score: 9.1 },
      { name: "Cultural Value", score: 8.4 },
      { name: "Infrastructure & Stays", score: 8.0 },
      { name: "Local Experience", score: 8.7 }
    ]
  },
  editorial: {
    why: "Muzaffarnagar is famously recognized as the 'Sugar Bowl of India'. Located in the fertile Upper Doab region, it houses one of Asia's largest jaggery (Gur) trading markets alongside deeply revered ancient pilgrimage sites like Shukratal.",
    story: "Founded during the Mughal era in 1633 by Jagir Pasha Khan and named after his father Muzaffar Khan, the region quickly evolved into an agricultural powerhouse. Its legendary connection to the Mahabharata epic through Shukratal gives it profound sacred heritage.",
    storyFull: "Beyond its sprawling sugarcane plantations and buzzing jaggery bazaars, Muzaffarnagar holds immense historical depth. Shukratal features the sacred 5,100-year-old Akshay Vat tree, under which Rishi Shukdev Goswami narrated the Srimad Bhagavata Purana to King Parikshit."
  },
  history: {
    shortIntro: "An ancient epic narrative site transformed into a modern agrarian empire.",
    timeline: [
      { year: "Vedic Era", event: "Rishi Shukdev Goswami narrates Mahabharata & Srimad Bhagavata Purana under Akshay Vat at Shukratal", era: "Ancient" },
      { year: "1633 AD", event: "Muzaffarnagar city established by Syed Jagir Pasha Khan in honor of his father Muzaffar Khan", era: "Mughal Era" },
      { year: "1826 AD", event: "Created as an independent administrative district under British administration", era: "Colonial Era" },
      { year: "Modern Era", event: "Emergence as Asia's premier jaggery trading hub and prominent industrial region in Western UP", era: "Contemporary" }
    ]
  },
  culture: [
    {
      title: "Jaggery (Gur) Trade Tradition",
      description: "Home to the largest jaggery market network in Asia, offering dozens of seasonal varieties from masala gur to peanut brittle.",
      image: 'https://images.unsplash.com/photo-1589301760014-d929f3979dbc?w=600&h=420&fit=crop&auto=format'
    },
    {
      title: "Shukratal Bhagavata Heritage",
      description: "Centuries-old devotional tradition centered on the recitation of Bhagavata Katha around the eternal Banyan tree (Akshay Vat).",
      image: 'https://d3sftlgbtusmnv.cloudfront.net/blog/wp-content/uploads/2024/12/Akshay-Vat-Vatika.jpg'
    },
    {
      title: "Sugarcane Farming Lifecycle",
      description: "Vibrant rural agrarian community defined by harvesting seasons, crushing mills, and lush green fields stretching across the Doab.",
      image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=600&h=420&fit=crop&auto=format'
    },
    {
      title: "Western UP Culinary Pride",
      description: "Hearty North Indian delicacies emphasizing fresh dairy, winter sesame sweets, earthy gur kheer, and traditional kadi pakora.",
      image: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=600&h=420&fit=crop&auto=format'
    }
  ],
  food: [
    {
    ...
    },
    {
      ...
      category: "Winter Specialty",
      price: "₹150–₹300/kg",
      image: 'https://images.unsplash.com/photo-1599488615731-7e5c2823ff28?w=600&h=420&fit=crop&auto=format'
    },
    {
    ...
    },
    {
      ...
      category: "Breakfast",
      price: "₹40–₹80",
      image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=600&h=420&fit=crop&auto=format'
    },
    {
      ...
      category: "Dessert",
      price: "₹50–₹100",
      image: 'https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?w=600&h=420&fit=crop&auto=format'
    },
    {
      ...
      category: "Beverage",
      price: "₹20–₹40",
      image: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=600&h=420&fit=crop&auto=format'
    },
    {
      name: "Tilkut (तिलकुट)",
  ...
  attractions: [
    {
      ...
      description: "Experience the heart of jaggery trade in one of Asia's premier Gur mandis.",
      duration: "1.5–2 hrs",
    ...
    },
    {
      ...
      description: "Historic garden and public park offering lush greenery and relaxing walking trails.",
      duration: "1–1.5 hrs",
      distance: "2 km from station",
      score: 8.4,
      image: 'https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=600&h=420&fit=crop&auto=format'
    },
    {
      id: "shukratal",
      name: "Shukratal",
      category: "Pilgrimage Site",
      description: "Sacred site on the banks of the Ganga where Maharishi Shukdev narrated Mahabharata to Parikshit.",
      duration: "3–4 hrs",
  ...
  hiddenGems: [
    {
      ...
      why: "Experience rural agricultural landscape with sprawling green fields and traditional sugarcane crushing units.",
      distance: "10 km outskirts",
      duration: "2 hrs",
      image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&h=500&fit=crop&auto=format'
    }
  ],
  thingsToDo: [
    { activity: "Jaggery Mandi & Tasting Tour", duration: "2 hrs", cost: "Free", difficulty: "Easy", bestTime: "Morning", image: "https://images.unsplash.com/photo-1589301760014-d929f3979dbc?w=600&h=400&fit=crop&auto=format" },
    { activity: "Pilgrimage Walk at Shukratal & Akshay Vat", duration: "3 hrs", cost: "Free", difficulty: "Easy", bestTime: "Morning/Evening", image: "https://d3sftlgbtusmnv.cloudfront.net/blog/wp-content/uploads/2024/12/Akshay-Vat-Vatika.jpg" },
    { activity: "Sugarcane Farm Trail & Fresh Juice Tasting", duration: "2 hrs", cost: "₹100–₹200", difficulty: "Easy", bestTime: "Afternoon", image: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=600&h=400&fit=crop&auto=format" }
  ],
  nearbyPlaces: [
    { name: "Hastinapur", distance: "35 km", type: "Mahabharata Capital & Jain Pilgrimage", travelTime: "45 min", image: "https://images.unsplash.com/photo-1609137144822-491c13d78905?w=500&h=340&fit=crop&auto=format" },
    { name: "Haridwar", distance: "85 km", type: "Holy Ganga Ghats", travelTime: "1.5 hrs", image: "https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=500&h=340&fit=crop&auto=format" },
    { name: "Meerut", distance: "55 km", type: "Historical & Industrial Hub", travelTime: "1 hr", image: "https://images.unsplash.com/photo-1591018653367-9c01498b3320?w=500&h=340&fit=crop&auto=format" }
  ],
  travel: {
    air: { airport: "Hindan Airport (GZB) / IGI Airport (DEL)", distance: "100 km / 130 km", time: "2–3 hrs via Delhi-Dehradun Expressway" },
    rail: { station: "Muzaffarnagar Railway Station (MOZ)", distance: "City centre", time: "Well connected on Northern Railway mainline to Delhi, Dehradun & Haridwar" },
    road: { highway: "Delhi-Dehradun Expressway / NH-58", distance: "120 km from Delhi", time: "2 hrs via expressway" }
  },
  stay: {
    categories: [
      { type: "Business Hotels", range: "₹1,500–₹4,000/night", options: ["Hotel Platinum", "Business Hotels catering to sugar industry professionals", "Hotel Sagar", "Golden Tulip Muzaffarnagar"] },
      { type: "Budget & Pilgrimage", range: "₹600–₹1,200/night", options: ["Shukratal Dharamshalas", "Station Road Lodges", "City Guest Houses"] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: "Budget Traveler", perDay: "₹800–₹1,500", breakdown: [{ category: "Stay", amount: "₹500–₹900" }, { category: "Food", amount: "₹200–₹400" }, { category: "Transport", amount: "₹100–₹200" }] },
      { tier: "Comfort", perDay: "₹2,500–₹4,500", breakdown: [{ category: "Stay", amount: "₹1,500–₹3,000" }, { category: "Food", amount: "₹600–₹1,000" }, { category: "Transport", amount: "₹400–₹800" }] }
    ]
  },
  itineraries: {
    '1 Day': [
      {
        day: 1,
        schedule: [
          { time: "8:00 AM", place: "Breakfast: Aloo Poori & Fresh Ganne ka Ras", duration: "45 min", distance: "City" },
          { time: "9:00 AM", place: "Jaggery Bazaars & Gur Mandi Exploration", duration: "2 hrs", distance: "Centre" },
          { time: "11:30 AM", place: "Company Bagh & Historic Garden Stroll", duration: "1.5 hrs", distance: "2 km" },
          { time: "2:00 PM", place: "Drive to Shukratal & Pilgrimage Darshan at Akshay Vat", duration: "3 hrs", distance: "30 km" },
          { time: "6:00 PM", place: "Return to city for Gajak, Revdi & Gur Shopping", duration: "1.5 hrs", distance: "City" }
        ]
      }
    ]
  },
  experiences: [
    { title: "Gur Mandi Trading Tour & Jaggery Tasting", duration: "2 hrs", price: "Free", category: "Agri-Tourism", image: "https://images.unsplash.com/photo-1589301760014-d929f3979dbc?w=600&h=400&fit=crop&auto=format" },
    { title: "Shukratal Spiritual & Bhagavata Katha Walk", duration: "3 hrs", price: "Free", category: "Pilgrimage", image: "https://d3sftlgbtusmnv.cloudfront.net/blog/wp-content/uploads/2024/12/Akshay-Vat-Vatika.jpg" }
  ],
  aiPrompts: [
    "What is special about the jaggery markets in Muzaffarnagar?",
    "How to reach Shukratal from Muzaffarnagar station?",
    "What are the top local food items to buy in Muzaffarnagar?"
  ],
  reviews: [
    { name: "Raman Verma", location: "Delhi", text: "Visiting the Gur Mandi was an unexpected highlight! The varieties of jaggery and fresh sugarcane products are unbelievable.", rating: 5, image: "https://images.unsplash.com/photo-1627894483216-2138af692e32?w=80&h=80&fit=crop&auto=format", date: "January 2026" },
    { name: "Pooja Sharma", location: "Haridwar", text: "Shukratal is extremely serene and spiritually soothing. The ancient Akshay Vat banyan tree fills you with immense peace.", rating: 5, image: "https://images.unsplash.com/photo-1571536802807-30451e3955d8?w=80&h=80&fit=crop&auto=format", date: "February 2026" }
  ],
  sources: {
    official: ["Uttar Pradesh Tourism (uptourism.gov.in)", "Muzaffarnagar District Portal (muzaffarnagar.nic.in)"],
    historical: ["Srimad Bhagavata Purana Records", "District Gazetteer of Muzaffarnagar"],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              <p className="font-mono text-xs text-white/50 mb-1">FOUNDED</p>
              <p className="font-display text-xl font-medium">1633 AD</p>
              <p className="text-xs text-white/60 mt-1">Syed Jagir Pasha Khan & Mahabharata Heritage</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-end justify-between mb-10">
          <div>
            ...
            <p className="text-d360-muted mt-2 text-sm">Don't leave without trying these iconic specialties.</p>
          </div>
        ...
        <div className="flex gap-5 overflow-x-auto scrollbar-hide pb-2 -mx-6 px-6 md:mx-0 md:px-0 md:grid md:grid-cols-3 lg:grid-cols-4">
...
function AttractionsGrid({ destination }: { destination: Destination }) {
  const tabs = ['All', 'Trade & Experience', 'Historic Park', 'Pilgrimage Site']
    ...
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mb-10">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-d360-ink leading-tight mb-8">Places to Visit</h2>
...
function NearbyPlaces({ destination }: { destination: Destination }) {
  const filters = ['35 km', '55 km', '85 km', 'All']
  ...
  return (
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-1 gap-8 max-w-2xl">
          {days.map((day) => (
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          <img src="https://d3sftlgbtusmnv.cloudfront.net/blog/wp-content/uploads/2024/12/Akshay-Vat-Vatika.jpg" alt={`Map of ${destination.name}`} className="w-full h-full object-cover opacity-40" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-8">Your intelligent guide to {destination.name}. Ask anything about history, jaggery trade, Shukratal, or local food delicacies.</p>
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('jaggery') && `${destination.name} is Asia's largest jaggery (Gur) trading hub! You can find dozens of varieties ranging from peanut-infused brittle, masala gur, and Tilkut to gourmet liquid jaggery at the Gur Mandi.`}
                  {selected?.includes('Shukratal') && `Shukratal is about 30 km east of ${destination.name} railway station. Easily accessible via local taxis or private buses (approx. 45 mins ride). It is home to the 5,100-year-old Akshay Vat banyan tree.`}
                  {selected?.includes('food') && `Must-try local foods include: ${destination.food.map(f => f.name).join(', ')}. Don't miss out on fresh Ganne ka Ras and winter Gajak!`}
                  {!selected?.includes('jaggery') && !selected?.includes('Shukratal') && !selected?.includes('food') && `${destination.name} offers rich agricultural and spiritual experiences: visit the Jaggery Markets, take a holy trip to Shukratal, or stroll through Company Bagh.`}
                </div>
              </div>
            )}
...
function PracticalInfo({ destination }: { destination: Destination }) {
  ...
  const items = [
    { title: 'Safety', content: `${destination.name} is a peaceful district in Western Uttar Pradesh. Exercise standard safety practices during crowded market visits.` },
    { title: 'Local Transport', content: `E-rickshaws, auto-rickshaws, and private taxis are ideal for navigating the city and visiting outer sites like Shukratal.` },
    { title: 'Photography Rules', content: `Photography is broadly permitted in public parks, sugarcane fields, and bazaars. Please observe silence and respect guidelines near inner sanctums at Shukratal.` },
    { title: 'Dress & Etiquette', content: `Modest attire is recommended when visiting holy sites in Shukratal. Footwear must be removed outside temples.` },
    { title: 'Emergency Information', content: `Police: 112 · Ambulance: 108 · District Hospital Muzaffarnagar provides primary emergency medical services.` },
    { title: 'Travel Tips', content: `The best season to witness the bustling jaggery trade and enjoy fresh winter sweets is between October and March.` }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-xs text-d360-muted mt-2">All information is cross-referenced with official tourism and district administrative data.</p>
          </div>
        </div>
      </div>
    </section>
...
export default function App() {
  const destination: Destination = muzaffarnagar
