...
const bijnor: Destination = {
  id: 'bijnor',
  slug: 'bijnor-uttar-pradesh',
  name: 'Bijnor',
  localName: 'बिजनौर',
  destinationType: 'Gateway to Uttarakhand',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Bijnor',
  shortDescription: 'Located near the foothills, known for sugarcane and unique sweets.',
  tags: ['HIMALAYAN', 'HERITAGE', 'CULTURAL'],
  hero: {
    image: 'https://im.hunt.in/cg/bijnaur/City-Guide/daranagar.jpg',
    poster: 'https://im.hunt.in/cg/bijnaur/City-Guide/daranagar.jpg'
  },
  quickFacts: {
    bestTime: 'Oct – Mar',
    duration: '1–2 Days',
    budget: '₹',
    destinationType: 'Foothills / River Belt',
    difficulty: 'Easy',
  ...
  editorial: {
    why: 'Known as the Gateway to Uttarakhand, Bijnor combines deep epic history from the Mahabharata era with rich agricultural heritage, lush sugarcane fields, and a distinct culinary fusion.',
    story: 'Nestled near the Himalayan foothills and flanked by the holy Ganges, Bijnor occupies a historical vantage point spanning back to ancient Vedic traditions.',
    storyFull: 'From being referenced in ancient epics like the Mahabharata (such as Vidur Kuti) to playing significant roles in medieval and colonial history through historic towns like Najibabad and Mandawar, Bijnor sits at the unique cultural intersection of Western Uttar Pradesh and the Garhwal/Kumaon regions of Uttarakhand.'
  },
  history: {
    shortIntro: 'An ancient landscape intertwined with epic folklore and regional heritage.',
    timeline: [
      { year: 'Ancient Era', event: 'Mahatma Vidur established his ashram (Vidur Kuti) near the banks of the Ganges during the Mahabharata era.', era: 'Vedic / Epic Era' },
      { year: '18th Century', event: 'Najib-ud-Daula founded Najibabad, constructing key Mughal-Rohilla architecture in the region.', era: 'Mughal / Rohilla Era' },
      { year: 'Modern Era', event: 'Evolved as a central pillar of Western UP’s agricultural belt, prominent for sugarcane manufacturing and sweetcraft.', era: 'Modern Era' }
    ]
  },
  culture: [
    {
      title: 'Gateway Culture',
      description: 'Positioned right at the border of Uttarakhand, Bijnor displays a rich mix of Western UP traditions and Kumaoni culinary/cultural influences.',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    },
    {
      title: 'Sugarcane Belt Heritage',
      description: 'Lush green sugarcane plantations define the local landscape, rural economy, and everyday food culture.',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    }
  ],
  food: [
  ...
  hiddenGems: [
    {
      ...
      why: 'Peaceful river views offering serene, uncrowded natural ambiance along the banks of the Ganges.',
      distance: '10 km from Bijnor',
      duration: '1–2 hrs',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    }
  ],
  thingsToDo: [
    { activity: 'Ganges River Walk', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Sunset/Sunrise', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { activity: 'Sugarcane Farm Visit', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { activity: 'Historic Trail in Najibabad', duration: '3 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Afternoon', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' }
  ],
  nearbyPlaces: [
    { name: 'Hastinapur', distance: '45 km', type: 'Pilgrimage & Heritage', travelTime: '1 hr', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { name: 'Kotdwar', distance: '50 km', type: 'Himalayan Gateway', travelTime: '1.2 hrs', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' }
  ],
  travel: {
    air: { airport: 'Dehradun Jolly Grant Airport (DED)', distance: '110 km', time: '~2.5 hrs by taxi' },
    rail: { station: 'Bijnor Railway Station (BJO)', distance: 'City Centre', time: 'Direct connectivity to major UP cities' },
    road: { highway: 'NH-34 / State Highways', distance: '160 km from Delhi', time: '~3.5–4 hrs by car' }
  },
  stay: {
    categories: [
      { type: 'Guest House', range: '₹800–₹2,000/night', options: ['Local Inns', 'Simple accommodations for travelers'] },
      { type: 'Mid-Range', range: '₹2,000–₹4,000/night', options: ['Town Hotels', 'Highway Lodges'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Traveller', perDay: '₹800–₹1,500', breakdown: [{ category: 'Stay', amount: '₹500–₹1,000' }, { category: 'Food', amount: '₹200–₹400' }, { category: 'Transport', amount: '₹100–₹200' }] },
  ...
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '8:00 AM', place: 'Poori Sabzi Breakfast', duration: '45 min' }, { time: '9:30 AM', place: 'Vidur Kuti Exploration', duration: '2 hrs' }, { time: '1:00 PM', place: 'Local Lunch & Fresh Ganne ka Ras', duration: '1 hr' }, { time: '3:00 PM', place: 'Najibabad Historic Trail', duration: '2.5 hrs' }, { time: '6:00 PM', place: 'Ganges Riverside Sunset', duration: '1 hr' }] }]
  },
  experiences: [
    { title: 'Sugarcane & Jaggery Tasting', duration: '2 hrs', price: '₹200–₹500', category: 'Food Trail', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { title: 'Mahabharata Trail Walk', duration: '3 hrs', price: '₹300–₹700', category: 'Culture', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' }
  ],
  aiPrompts: ["What is Bijnor famous for?", "Must try sweets in Bijnor?", "How to reach Vidur Kuti?", "Plan a 1 day trip to Bijnor"],
  reviews: [
    { name: 'Rohan Verma', location: 'Delhi', text: 'Bijnor is a hidden gem right on the border of UP and Uttarakhand. Vidur Kuti is calm, and the local Bal Mithai was unexpected!', rating: 5, image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000', date: 'February 2026' }
  ],
  sources: {
    official: ['Uttar Pradesh Tourism (uptourism.gov.in)', 'Bijnor District Portal (bijnor.nic.in)'],
    historical: ['Gazetteer of Bijnor District'],
...
function AttractionsGrid({ destination }: { destination: Destination }) {
  const tabs = ['All', 'Pilgrimage', 'Heritage Town', 'Historical']
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-8">Your intelligent guide to {destination.name}. Ask anything about local food, sweets, history, or travel plans.</p>
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('sweets') && `Must-try sweets in Bijnor include Bal Mithai (roasted khoya fudge with white sugar balls), Singori (steamed khoya in Malu leaf), and seasonal Makhan Malai in the winter.`}
                  {selected?.includes('famous') && `Bijnor is known as the Gateway to Uttarakhand and is famous for its sugarcane belt, Ganne ka Ras, Vidur Kuti from Mahabharata, and historic Mughal architecture at Najibabad.`}
                  {selected?.includes('Vidur Kuti') && `Vidur Kuti is located around 12 km from Bijnor city center near the Ganges. It can easily be reached via local auto-rickshaw, taxi, or private road transport.`}
                  {selected?.includes('1 day') && `For a 1-day trip: start with a morning visit to Vidur Kuti, have fresh Ganne ka Ras and local Kadhi Pakora, explore the historical sites at Najibabad in the afternoon, and end your day by the Ganges Riverside.`}
                </div>
              </div>
            )}
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={bijnor} />
      <QuickFacts facts={bijnor.quickFacts} />
      <WhyVisit destination={bijnor} />
      <DestinationStory destination={bijnor} />
      <HistoryTimeline destination={bijnor} />
      <CultureGrid destination={bijnor} />
      <FoodSection destination={bijnor} />
      <AttractionsGrid destination={bijnor} />
      <HiddenGems destination={bijnor} />
      <ThingsToDo destination={bijnor} />
      <NearbyPlaces destination={bijnor} />
      <HowToReach destination={bijnor} />
      <WhereToStay destination={bijnor} />
      <BestTime destination={bijnor} />
      <BudgetGuide destination={bijnor} />
      <Itineraries destination={bijnor} />
      <LocalExperiences destination={bijnor} />
      <AskD360 destination={bijnor} />
      <CommunityStories destination={bijnor} />
      <SourcesTrust destination={bijnor} />
      <Footer />
    </div>
  )
}