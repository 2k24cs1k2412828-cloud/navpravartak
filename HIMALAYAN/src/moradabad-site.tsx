...
export const moradabad: Destination = {
  id: 'moradabad',
  slug: 'moradabad-uttar-pradesh',
  name: 'Moradabad',
  localName: 'मुरादाबाद',
  destinationType: 'Brass Handicrafts & Culinary Hub',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Moradabad',
  shortDescription: 'World-famous for its brass handicrafts and unique culinary traditions.',
  tags: ['BRASS CITY', 'HANDICRAFTS', 'CULINARY HUB'],
  hero: {
    image: 'https://upload.wikimedia.org/wikipedia/commons/9/94/Methodist_Church_Moradabad.jpg',
    poster: 'https://upload.wikimedia.org/wikipedia/commons/9/94/Methodist_Church_Moradabad.jpg'
  },
  quickFacts: {
    bestTime: 'Oct – Mar',
    duration: '1–2 Days',
    budget: '₹₹',
    destinationType: 'Handicraft & Food Destination',
    difficulty: 'Easy',
    distance: '~160 km from Delhi NCR'
  },
  discoveryScore: {
    overall: 8.7,
    categories: [
      { name: 'Brass Handicraft Heritage', score: 9.8 },
      { name: 'Culinary Traditions', score: 9.5 },
      { name: 'Mughal & Colonial History', score: 8.5 },
      { name: 'Local Markets', score: 8.9 },
      { name: 'Accessibility', score: 9.0 }
    ]
  },
  editorial: {
    why: 'Moradabad is internationally acclaimed as the "Pital Nagri" (Brass City) of India, exporting handcrafted brass metalwork globally while offering an iconic regional food culture.',
    story: 'Established in 1625 by Rustam Khan, the governor of Sambhal under Mughal Emperor Shah Jahan, Moradabad was named after Prince Murad Bakhsh. Over centuries, it evolved into India\'s premiere metalware manufacturing capital.',
    storyFull: 'Along with its industrial prowess, Moradabad is world-renowned for its distinct food culture—most notably Moradabadi Dal and aromatic Moradabadi Biryani—bringing together centuries of artisan craftsmanship and rich flavors.'
  },
  history: {
    shortIntro: 'Founded in the 17th century by Rustam Khan and developed into a global metalcraft capital.',
    timeline: [
      { year: '1625', event: 'Founded by Rustam Khan and named Moradabad after Prince Murad Bakhsh', era: 'Mughal Era' },
      { year: '1631', event: 'Construction of Jama Masjid by Rustam Khan, marking major architectural expansion', era: 'Mughal Era' },
      { year: '1858', event: 'Becomes an administrative district under British rule following the 1857 uprising', era: 'Colonial Era' },
      { year: '1900s+', event: 'Surges into a global export hub for brassware, gaining international acclaim', era: 'Contemporary' }
    ]
  },
  culture: [
    {
      title: 'Brass Artisanship',
      description: 'Centuries-old metal casting, engraving, and polishing traditions passed down through generations of artisans.',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    },
    {
      title: 'Mughal Heritage',
      description: 'Historical architecture characterized by grand mosques, serene courtyards, and classical brickwork.',
      image: 'https://upload.wikimedia.org/wikipedia/commons/9/94/Methodist_Church_Moradabad.jpg'
    },
    {
      title: 'Culinary Identity',
      description: 'Distinguished local flavors featuring delicate Moong Dal preparations, mild aromatic biryani, and rich kormas.',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    },
    {
      title: 'Market Culture',
      description: 'Bustling bazaars filled with intricate brass artifacts, traditional sweets, and vibrant street vendors.',
      image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000'
    }
  ],
  food: [
    ...
    {
      name: 'Multani Chhole Chawal (मुल्तानी छोले चावल)',
  ...
  attractions: [
    {
      ...
      description: 'Beautiful mosque with Mughal architecture built by Rustam Khan in 1631 along the Ramganga riverbank.',
      duration: '1 hr',
    ...
    },
    {
      ...
      name: 'Sai Temple',
      category: 'Pilgrimage',
      description: 'Popular pilgrimage site welcoming devotees across all communities in a peaceful ambiance.',
      duration: '1 hr',
    ...
    {
      id: 'brass-handicraft-market',
      name: 'Brass Handicraft Market',
      category: 'Heritage Craft',
      description: 'Explore centuries-old brass craft tradition with hundreds of artisan shops selling intricate decor and cookware.',
      duration: '2–3 hrs',
  ...
  hiddenGems: [
    {
      ...
      why: 'Water park and amusement park providing recreational fun and family activities.',
  ...
  thingsToDo: [
    { activity: 'Explore Brass Handicraft & Export Markets', duration: '2.5 hrs', cost: 'Free to browse', difficulty: 'Easy', bestTime: 'Afternoon', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { activity: 'Authentic Moradabadi Dal Tasting Walk', duration: '1.5 hrs', cost: '₹100–₹200', difficulty: 'Easy', bestTime: 'Morning / Evening', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { activity: 'Visit Jama Masjid & Ramganga Riverbank', duration: '1 hr', cost: 'Free', difficulty: 'Easy', bestTime: 'Early Morning', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' }
  ],
  nearbyPlaces: [
    { name: 'Rampur', distance: '30 km', type: 'Raza Library & Nawabi Heritage', travelTime: '45 min', image: 'https://upload.wikimedia.org/wikipedia/commons/9/94/Methodist_Church_Moradabad.jpg' },
    { name: 'Corbett National Park Gateway', distance: '85 km', type: 'Wildlife & Nature', travelTime: '2 hrs', image: 'https://upload.wikimedia.org/wikipedia/commons/9/94/Methodist_Church_Moradabad.jpg' }
  ],
  travel: {
    air: { airport: 'Pantnagar Airport (PGH) / IGI Delhi (DEL)', distance: '85 km / 170 km', time: '2 hrs / 3.5 hrs via highway' },
    rail: { station: 'Moradabad Junction (MB)', distance: 'City centre', time: 'Major railway hub directly connected to Delhi & Lucknow' },
    road: { highway: 'Delhi–Moradabad Highway (NH-9)', distance: '160 km from Delhi', time: '3–3.5 hrs via NH-9' }
  },
  stay: {
    categories: [
      { type: 'Heritage & Boutique Hotels', range: '₹2,000–₹5,500/night', options: ['Hotels showcasing brass city heritage', 'Hotel Holiday Regency', 'Nivah Stay'] },
      { type: 'Standard Business Hotels', range: '₹1,200–₹2,800/night', options: ['Hotel Grand Sai', 'Hotel Mansarover Paradise'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Explorer', perDay: '₹900–₹1,600', breakdown: [{ category: 'Stay', amount: '₹500–₹900' }, { category: 'Food', amount: '₹200–₹400' }, { category: 'Transport', amount: '₹150–₹300' }] },
      { tier: 'Comfort', perDay: '₹2,200–₹4,500', breakdown: [{ category: 'Stay', amount: '₹1,500–₹3,000' }, { category: 'Food', amount: '₹400–₹900' }, { category: 'Transport', amount: '₹300–₹600' }] }
    ]
  },
  itineraries: {
    '1 Day': [
      {
        day: 1,
        schedule: [
          { time: '8:30 AM', place: 'Authentic Moradabadi Dal breakfast in Old Bazaar', duration: '45 min', distance: 'City' },
          { time: '9:30 AM', place: 'Jama Masjid & Mughal architecture exploration', duration: '1 hr', distance: 'Centre' },
          { time: '11:00 AM', place: 'Brass Handicraft Market artisan shopping tour', duration: '2.5 hrs', distance: 'Market' },
          { time: '2:00 PM', place: 'Lunch: Moradabadi Biryani & Mutton Korma', duration: '1 hr', distance: 'Town' },
          { time: '3:30 PM', place: 'Visit Sai Temple', duration: '1 hr', distance: '3 km' },
          { time: '5:00 PM', place: 'Sweets trail: Dal Jalebi tasting in street markets', duration: '1 hr', distance: 'Bazaar' }
        ]
      }
    ]
  },
  experiences: [
    { title: 'Brass Metalwork Workshop & Artisan Tour', duration: '2 hrs', price: '₹300–₹600', category: 'Handicraft Tour', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { title: 'Moradabadi Dal & Biryani Culinary Trail', duration: '2 hrs', price: '₹200–₹500', category: 'Culinary Walk', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' }
  ],
  aiPrompts: [
    'What makes Moradabadi Dal so unique compared to regular dal?',
    'Where are the best places to buy authentic brass souvenirs in Moradabad?',
    'What is the history behind Moradabad\'s title as Brass City?',
    'How to visit Moradabad as a day trip from Delhi via NH-9?'
  ],
  reviews: [
    { name: 'Aman Agarwal', location: 'Delhi', text: 'Buying brass artifacts straight from local craftsmen was an unforgettable experience. And the local Moradabadi Dal is genuinely addictive!', rating: 5, image: 'https://upload.wikimedia.org/wikipedia/commons/9/94/Methodist_Church_Moradabad.jpg', date: 'January 2026' },
    { name: 'Priya Saxena', location: 'Lucknow', text: 'The biryani here is surprisingly light, fragrant, and delicious. Moradabad offers a wonderful blend of food, culture, and rich craft history.', rating: 5, image: 'https://upload.wikimedia.org/wikipedia/commons/9/94/Methodist_Church_Moradabad.jpg', date: 'February 2026' }
  ],
  sources: {
    official: ['Uttar Pradesh Tourism (uptourism.gov.in)', 'Moradabad District Portal (moradabad.nic.in)'],
    historical: ['Gazetteer of Moradabad District', 'Handicrafts Board of India Reports'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              ...
              <p className="font-display text-xl font-medium">1625 AD</p>
              <p className="text-xs text-white/60 mt-1">Established by Rustam Khan under Shah Jahan</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-2xl mb-12">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-d360-ink leading-tight">A Legacy of Brass and Empire</h2>
...
function CultureGrid({ destination }: { destination: Destination }) {
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mb-12">
          <p className="text-d360-primary text-xs font-mono tracking-widest mb-4">CULTURE & CRAFT</p>
          <h2 className="font-display text-3xl md:text-4xl text-d360-ink leading-tight">The Heritage of {destination.name}</h2>
        </div>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-end justify-between mb-10">
          <div>
            <p className="text-d360-primary text-xs font-mono tracking-widest mb-4">FAMOUS DISHES</p>
            <h2 className="font-display text-3xl md:text-4xl text-d360-ink leading-tight">Taste of {destination.name}</h2>
            <p className="text-d360-muted mt-2 text-sm">Unique culinary traditions that define the city.</p>
          </div>
          <button className="hidden md:flex items-center gap-2 text-sm font-medium text-d360-primary hover:gap-3 transition-all">Explore Culinary Scene <IconArrowRight /></button>
        </div>
        ...
        <button className="md:hidden mt-6 flex items-center gap-2 text-sm font-medium text-d360-primary">Explore Culinary Scene <IconArrowRight /></button>
      </div>
    </section>
  )
}
...
function AttractionsGrid({ destination }: { destination: Destination }) {
  const tabs = ['All', 'Mughal Architecture', 'Pilgrimage', 'Heritage Craft']
  ...
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mb-10">
          <p className="text-d360-primary text-xs font-mono tracking-widest mb-4">PLACES TO VISIT</p>
    ...
    <section className="bg-d360-ink py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mb-12">
          ...
          <p className="text-white/50 mt-2 text-sm">Spots off the typical tourist path.</p>
        </div>
...
function NearbyPlaces({ destination }: { destination: Destination }) {
  const filters = ['30 km', '100 km', 'All']
    ...
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mb-10">
          ...
          <h2 className="font-display text-3xl md:text-4xl text-d360-ink leading-tight mb-6">Excursions & Day Trips</h2>
...
function WhereToStay({ destination }: { destination: Destination }) {
  ...
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="mb-10">
          <p className="text-d360-primary text-xs font-mono tracking-widest mb-4">STAYING PLACES</p>
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          <img src="https://upload.wikimedia.org/wikipedia/commons/9/94/Methodist_Church_Moradabad.jpg" alt={`Map of ${destination.name}`} className="w-full h-full object-cover opacity-40" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-8">Your intelligent guide to {destination.name}. Ask anything about brass handicrafts, famous dishes, travel routes, or heritage sights.</p>
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('Dal') && `Moradabadi Dal is made from light Moong Dal and served hot with fried onions, green chilies, lemon juice, and spicy chaat masala.`}
                  {selected?.includes('brass') && `Head directly to the main Brass Handicraft Market to explore hundreds of shops showcasing intricate traditional brass decor and metalware.`}
                  {selected?.includes('Brass City') && `Moradabad earned its name due to its massive brass export industry, generating thousands of local artisan jobs and supplying handcrafted metalware worldwide.`}
                  {selected?.includes('Delhi') && `Moradabad is easily accessible from Delhi via NH-9 in around 3 to 3.5 hours, or via frequent express trains from New Delhi station.`}
                  {!selected?.includes('Dal') && !selected?.includes('brass') && !selected?.includes('Brass City') && !selected?.includes('Delhi') && `${destination.name} offers rich heritage: explore ${destination.attractions[0]?.name}, sample local delicacies like ${destination.food[0]?.name}, and discover the culture of ${destination.district}.`}
                </div>
              </div>
            )}
...
function PracticalInfo({ destination }: { destination: Destination }) {
  ...
  const items = [
    { title: 'Safety & Shopping', content: `${destination.name} is a busy industrial hub. Take care of personal belongings when navigating crowded bazaar areas like the Brass Market.` },
    { title: 'Local Transport', content: `Auto-rickshaws and e-rickshaws are readily available across the city for easy transport between the railway station, Jama Masjid, and major markets.` },
    { title: 'Bargaining Tips', content: `Negotiating prices is common practice in the brass retail markets. Inspect metal items for weight and finishing quality before purchasing.` },
    { title: 'Emergency Contact', content: `Police: 112 · Ambulance: 108 · UP Tourism Helpline: 1800-180-1414.` }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
function Footer() {
  const links = {
    Explore: ['Destinations', 'Hidden Gems', 'Heritage Sites', 'Handicraft Hubs'],
    Plan: ['Trip Planner', 'Itineraries', 'Budget Guide', 'Ask D360'],
    Experiences: ['Local Tours', 'Food Trails', 'Artisan Workshops', 'Heritage Walks'],
...
export default function App() {
  const destination: Destination = moradabad
