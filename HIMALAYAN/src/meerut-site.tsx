...
export const meerut: Destination = {
  id: 'meerut',
  slug: 'meerut-uttar-pradesh',
  name: 'Meerut',
  localName: 'मेरठ',
  destinationType: 'Sports & Heritage Hub',
  country: 'India',
  state: 'Uttar Pradesh',
  district: 'Meerut',
  shortDescription: 'The Sports City with Rich Heritage, known for its sports goods industry and historical significance in the 1857 uprising.',
  tags: ['HERITAGE', 'SPORTS CITY', 'FREEDOM STRUGGLE'],
  hero: {
    image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg',
    poster: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg'
  },
  quickFacts: {
    bestTime: 'Oct – Mar',
    duration: '1–2 Days',
    budget: '₹₹',
    destinationType: 'Historical & Industrial Hub',
    difficulty: 'Easy',
    distance: '~70 km from Delhi NCR'
  },
  discoveryScore: {
    overall: 8.8,
    categories: [
      { name: 'Historical Significance', score: 9.7 },
      { name: 'Cultural Heritage', score: 9.0 },
      { name: 'Local Culinary', score: 9.2 },
      { name: 'Industrial Hub', score: 8.9 },
      { name: 'Accessibility', score: 9.5 }
    ]
  },
  editorial: {
    why: 'Meerut is globally recognized for its world-class sports manufacturing industry while standing as a proud pillar of Indian history where the First War of Independence erupted in 1857.',
    story: 'From ancient links to the Mahabharata epic (Hastinapur) to the spark that ignited the 1857 Sepoy Mutiny against East India Company rule, Meerut plays an indispensable role in India\'s cultural evolution.',
    storyFull: 'Today, Meerut seamlessly blends modern industrial growth with legacy landmarks. Thousands visit the famous Nauchandi Mela and explore bustling local bazaars known worldwide for sports manufacturing, scissors, and traditional sweets like Gajak and Revdi.'
  },
  history: {
    shortIntro: 'The epic epicenter of Hastinapur and the cradle of the 1857 War of Independence.',
    timeline: [
      { year: 'Antiquity', event: 'Hastinapur serves as the magnificent capital of the Kuru Kingdom in the Mahabharata era', era: 'Ancient Era' },
      { year: '1857', event: 'The Indian Mutiny erupts at Meerut Cantonment, igniting India\'s First War of Independence', era: 'Freedom Struggle' },
      { year: '1880', event: 'Establishment of Nauchandi Mela into a prominent annual cultural and commercial fair', era: 'Colonial Era' },
      { year: '1947+', event: 'Evolves into India\'s leading sports equipment manufacturing and export powerhouse', era: 'Contemporary' }
    ]
  },
  culture: [
    {
      title: '1857 Revolution Heritage',
      description: 'The heroic legacy of Indian soldiers who defied British rule at Kali Paltan Mandir and Cantonment.',
      image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg'
    },
    {
      title: 'Nauchandi Mela Tradition',
      description: 'Historic annual carnival representing communal harmony, traditional crafts, and vibrant local trade.',
      image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg'
    },
    {
      title: 'World Sports Manufacturing',
      description: 'Home to master craftsmen producing international-grade cricket bats, balls, and equipment.',
      image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg'
    },
    {
      title: 'Confectionery & Sweets',
      description: 'Generations-old sweet-making heritage, celebrated for winter sesame treats, crispy Naan Khatai, and kebabs.',
      image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg'
    }
  ],
  food: [
    {
      ...
      category: 'Sweet / Winter Specialty',
      price: '₹100–₹250',
  ...
  attractions: [
    {
      id: 'shahid-smarak',
      name: 'Shahid Smarak',
      category: '1857 Memorial',
      description: 'Memorial for martyrs of 1857 uprising dedicated to Indian soldiers who initiated the revolution.',
      duration: '1–2 hrs',
    ...
    },
    {
      ...
      description: 'Ancient temple and sacred pond surrounded by peaceful parks and old temples.',
      duration: '1 hr',
    ...
    },
    {
      ...
      description: 'Historic church from British era established in 1819, set within tranquil Cantonment grounds.',
      duration: '1 hr',
  ...
  hiddenGems: [
    {
      name: 'Gandhi Bagh',
      why: 'Peaceful garden in city center featuring lush green lawns, musical fountains, and shaded walkways.',
  ...
  thingsToDo: [
    { activity: 'Explore 1857 Martyr Memorial & Museum', duration: '2 hrs', cost: 'Free', difficulty: 'Easy', bestTime: 'Morning', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { activity: 'Shop Genuine Sports Goods at Suraj Kund Market', duration: '2 hrs', cost: 'Varies', difficulty: 'Easy', bestTime: 'Afternoon', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' },
    { activity: 'Sample Traditional Gajak & Naan Khatai Trail', duration: '1.5 hrs', cost: '₹150–₹300', difficulty: 'Easy', bestTime: 'Evening', image: 'https://drive.google.com/thumbnail?id=PLACEHOLDER_ID&sz=w2000' }
  ],
  nearbyPlaces: [
    { name: 'Hastinapur', distance: '37 km', type: 'Mahabharata Heritage & Jain Temples', travelTime: '1 hr', image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg' },
    { name: 'Sardhana (Church of Our Lady of Graces)', distance: '22 km', type: 'Begum Samru Basilica', travelTime: '40 min', image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg' }
  ],
  travel: {
    air: { airport: 'Hindon Airport (HDO) / IGI Delhi (DEL)', distance: '50 km / 80 km', time: '1.5 – 2 hrs via expressway' },
    rail: { station: 'Meerut City Junction (MTC)', distance: 'City centre', time: 'Direct Vande Bharat & Express connectivity' },
    road: { highway: 'Delhi–Meerut Expressway (NE-3)', distance: '70 km from Delhi', time: '45 mins via Delhi-Meerut Expressway' }
  },
  stay: {
    categories: [
      { type: 'City Hotels', range: '₹1,500–₹4,500/night', options: ['Modern hotels near commercial areas', 'Hotel Harmony Inn', 'Hotel Drive Inn'] },
      { type: 'Heritage / Luxury', range: '₹4,500–₹9,000/night', options: ['Bravura Gold Resort', 'Godwin Hotel'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      ...
      { tier: 'Comfort', perDay: '₹2,500–₹5,000', breakdown: [{ category: 'Stay', amount: '₹1,800–₹3,500' }, { category: 'Food', amount: '₹500–₹1,000' }, { category: 'Transport', amount: '₹300–₹800' }] }
    ]
  },
  itineraries: {
    '1 Day': [
      {
        day: 1,
        schedule: [
          { time: '8:00 AM', place: 'Poori Sabzi breakfast in City Bazaar', duration: '45 min', distance: 'City' },
          { time: '9:30 AM', place: 'Shahid Smarak & 1857 Freedom Struggle Museum', duration: '2 hrs', distance: 'Centre' },
          { time: '12:00 PM', place: 'St. John\'s Church & Cantonment heritage walk', duration: '1.5 hrs', distance: 'Cantt' },
          { time: '2:00 PM', place: 'Lunch: Mughlai Shami Kebabs & Paneer Pasanda', duration: '1 hr', distance: 'Town' },
          { time: '3:30 PM', place: 'Suraj Kund park & Sports goods shopping market', duration: '2 hrs', distance: '3 km' },
          { time: '6:00 PM', place: 'Evening walk at Gandhi Bagh', duration: '1 hr', distance: '2 km' },
          { time: '7:30 PM', place: 'Famous Gajak, Revdi & Naan Khatai shopping', duration: '1 hr', distance: 'Bazaar' }
        ]
      }
    ]
  },
  experiences: [
    { title: '1857 Sepoy Mutiny Freedom Trail', duration: '2.5 hrs', price: 'Free', category: 'Heritage Walk', image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg' },
    { title: 'Cricket Bat Factory & Sports Craft Tour', duration: '2 hrs', price: '₹200–₹500', category: 'Industrial', image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg' },
    { title: 'Meerut Winter Sweet Tasting Trail', duration: '1.5 hrs', price: '₹200–₹400', category: 'Culinary', image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg' }
  ],
  aiPrompts: [
    'What is Meerut famous for in 1857 history?',
    'Where to buy genuine cricket bats and sports equipment in Meerut?',
    'Best shops to buy Gajak, Revdi, and Naan Khatai in Meerut?',
    'How to travel from Delhi to Meerut via Delhi-Meerut Expressway?'
  ],
  reviews: [
    { name: 'Rohan Sharma', location: 'Delhi', text: 'Traveling to Meerut via the Expressway took under an hour. Exploring Shahid Smarak and buying sports equipment directly from factory outlets was fantastic.', rating: 5, image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg', date: 'January 2026' },
    { name: 'Ananya Verma', location: 'Noida', text: 'The winter Gajak and fresh Naan Khatai from Meerut market are unbeatable! A rich blend of culinary culture and colonial history.', rating: 5, image: 'https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg', date: 'February 2026' }
  ],
  sources: {
    official: ['Uttar Pradesh Tourism (uptourism.gov.in)', 'Meerut District Administration (meerut.nic.in)'],
    historical: ['1857 Mutiny Records', 'Gazetteer of the Meerut District'],
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 hidden lg:block bg-d360-ink text-white px-6 py-4" style={{ maxWidth: '240px', borderRadius: '2px' }}>
              <p className="font-mono text-xs text-white/50 mb-1">HISTORIC ERA</p>
              <p className="font-display text-xl font-medium">1857 AD</p>
              <p className="text-xs text-white/60 mt-1">Cradle of India's First War of Independence</p>
            </div>
          </div>
        </div>
      </div>
...
function AttractionsGrid({ destination }: { destination: Destination }) {
  const tabs = ['All', '1857 Memorial', 'Ancient Heritage', 'Colonial Architecture']
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          <img src="https://upload.wikimedia.org/wikipedia/commons/1/18/Mustafa_Castle_--_night_shot.jpg" alt={`Map of ${destination.name}`} className="w-full h-full object-cover opacity-40" />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-8">Your intelligent guide to {destination.name}. Ask anything about history, sports goods industry, hidden gems, or local food trails.</p>
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('1857') && `Meerut is the cradle of India's 1857 First War of Independence. Visit Shahid Smarak and Kali Paltan Mandir where local soldiers stood up against British rule.`}
                  {selected?.includes('sports') && `Head directly to Suraj Kund Market and local Cantonment factory outlets to buy world-class cricket bats, balls, and athletic equipment straight from manufacturers.`}
                  {selected?.includes('Gajak') && `Top traditional delicacies include Gajak, Revdi, Naan Khatai, and Shami Kebabs available across central bazaar sweet houses.`}
                  {selected?.includes('Expressway') && `You can reach Meerut from Delhi NCR in under 45 minutes via the Delhi–Meerut Expressway (NE-3).`}
                  {!selected?.includes('1857') && !selected?.includes('sports') && !selected?.includes('Gajak') && !selected?.includes('Expressway') && `${destination.name} offers incredible cultural richness: explore ${destination.attractions[0]?.name}, enjoy local ${destination.food[0]?.name}, and discover the historical heritage of ${destination.district}.`}
                </div>
              </div>
            )}
...
function PracticalInfo({ destination }: { destination: Destination }) {
  ...
  const items = [
    { title: 'Safety', content: `${destination.name} is a busy commercial and historical district in western Uttar Pradesh. Stay mindful of personal belongings in crowded markets like Nauchandi or central bazaars.` },
    { title: 'Local Transport', content: `E-rickshaws, shared autos, and taxis are widely available to travel between Meerut Cantonment, Shahid Smarak, and Suraj Kund.` },
    { title: 'Shopping Rules', content: `Bargaining is common in local markets. For sports equipment, compare factory outlets around Suraj Kund for original quality.` },
    { title: 'Emergency Information', content: `Police: 112 · Ambulance: 108 · UP Tourism Helpline: 1800-180-1414.` }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  const destination: Destination = meerut
