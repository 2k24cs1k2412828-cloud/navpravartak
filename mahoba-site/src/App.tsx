...
const mahoba: Destination = {
  id: 'mahoba', slug: 'mahoba-uttar-pradesh', name: 'Mahoba', localName: 'महोबा',
  destinationType: 'City of Chandela Kings', country: 'India', state: 'Uttar Pradesh', district: 'Mahoba',
  established: { year: '831 AD', by: 'Nannuk (Chandela Dynasty)' },
  shortDescription: 'Historic capital of the Chandela dynasty famous for Sun Temple, warrior legends of Alha-Udal, and 52 ancient lakes.',
  tags: ['HERITAGE', 'HISTORICAL', 'CHANDELA', 'LAKES'],
  hero: {
    image: 'https://www.jagranimages.com/images/newimg/01072022/Mahoba(1).jpg',
  ...
  quickFacts: {
    ...
    destinationType: 'Heritage City', difficulty: 'Easy', distance: '~140 km from Jhansi / 65 km Khajuraho'
  },
  discoveryScore: {
    overall: 8.6,
    categories: [
      { name: 'Uniqueness', score: 9.1 },
      { name: 'Historical Significance', score: 9.5 },
      { name: 'Cultural Value', score: 9.0 },
      { name: 'Crowd Level', score: 4.2 },
      { name: 'Local Experience', score: 8.4 }
    ]
  },
  editorial: {
    why: 'Mahoba is the ancient cradle of Chandela architecture and the immortal land of legendary warriors Alha and Udal. Renowned for its 9th-century Sun Temple and sophisticated ancient water engineering of 52 lakes.',
    story: 'Before Khajuraho became world-famous, Mahoba was the political capital of the Chandela dynasty. Here, mighty rulers carved Sun Temples, constructed massive stone lakes, and fought historic battles.',
    storyFull: 'The Sun Temple (Surya Mandir) at Rahila Sagar stands as a magnificent testament to 9th-century granite stone carving, rivaling Konark and Modhera. The ballads of Alha-Khand still echo in Mahoba, celebrating the heroic deeds of Alha and Udal who defended Mahoba against Prithviraj Chauhan. The interconnected lake systems like Kirat Sagar and Madan Sagar showcase medieval India\'s supreme water management.'
  },
  history: {
    shortIntro: 'Capital of Chandela dynasty where martial valor meets ancient stone architecture and lake engineering.',
    timeline: [
      { year: '831 CE', event: 'Nannuk establishes the Chandela dynasty with Mahoba as its capital city', era: 'Chandela Foundation' },
      { year: '890 CE', event: 'King Rahila builds the granite Sun Temple (Surya Mandir) and Rahila Sagar lake', era: 'Chandela Era' },
      { year: '1070 CE', event: 'King Kirat Singh constructs the 50-acre Kirat Sagar artificial lake fortification', era: 'Chandela Golden Age' },
      { year: '1182 CE', event: 'Epic Battle of Mahoba fought between Chandela warriors Alha-Udal and King Prithviraj Chauhan', era: 'Heroic Age' },
      { year: '1857', event: 'Mahoba freedom fighters participate actively in the Sepoy Mutiny against British rule', era: 'Freedom Movement' }
    ]
  },
  culture: [
    { title: 'Chandela Granite Carving', description: 'Mahoba\'s temples showcase rare granite stone architecture preceding the sandstone temples of Khajuraho.', image: 'https://images.unsplash.com/photo-1600100397608-f010e423b961?w=600&h=400&fit=crop&auto=format' },
    { title: 'Alha-Khand Folk Ballads', description: 'Live oral tradition of singing Alha ballads, celebrating bravery, martial honor, and patriot spirit of Bundelkhand.', image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=600&h=400&fit=crop&auto=format' },
    { title: 'Ancient Lake Engineering', description: 'System of 52 interconnected artificial lakes built with stone ghats and underground overflow channels.', image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600&h=400&fit=crop&auto=format' },
    { title: 'Brassware & Pottery', description: 'Traditional metalcraft, brass lamps, and handcrafted clay utensils made by local artisan communities.', image: 'https://images.unsplash.com/photo-1544717305-2782549b5136?w=600&h=400&fit=crop&auto=format' }
  ],
  food: [
    { name: 'Bundeli Thali', description: 'Full authentic meal with baked wheat baati, spiced mixed dal, roasted brinjal/potato chokha, and ghee raita.', category: 'Main Course', price: '₹120–₹220', image: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=500&h=360&fit=crop&auto=format' },
    { name: 'Aloo Bada', description: 'Spiced mashed potato balls coated in gram flour batter, deep-fried to golden crispness. Served with green chili chutney.', category: 'Street Food', price: '₹20–₹40', image: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=500&h=360&fit=crop&auto=format' },
    { name: 'Mawa Jalebi', description: 'Rich, thick version of jalebi prepared from khoya (reduced milk solids) and fried in desi ghee, soaked in cardamon sugar syrup.', category: 'Sweet', price: '₹180–₹320/kg', image: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=500&h=360&fit=crop&auto=format' },
    { name: 'Bundeli Papad & Chutney', description: 'Hand-rolled lentil wafers spiked with black pepper and asafoetida, served with tangy raw mango or garlic chutney.', category: 'Snack', price: '₹30–₹60', image: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&h=360&fit=crop&auto=format' }
  ],
  attractions: [
    { id: 'sun-temple-rahila', name: 'Sun Temple - Surya Mandir (Rahila Sagar)', category: 'Chandela Heritage', description: 'Majestic 9th-century granite Sun Temple built by King Rahila with solar alignment and stone carved pillars.', duration: '2 hrs', distance: '3 km from Mahoba center', score: 9.5, image: 'https://images.unsplash.com/photo-1600100397608-f010e423b961?w=600&h=420&fit=crop&auto=format' },
    { id: 'kirat-sagar', name: 'Kirat Sagar Lake & Ghats', category: 'Historic Lake', description: '50-acre artificial lake constructed in 11th century with massive stone embankments and sunset boat rides.', duration: '2 hrs', distance: '1.5 km from town', score: 9.1, image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600&h=420&fit=crop&auto=format' },
    { id: 'mahoba-fort', name: 'Mahoba Fort Ruins', category: 'Medieval Fort', description: '9th-century fortress capital of Chandelas boasting defensive walls, ancient gateways, and hill overlook points.', duration: '2–3 hrs', distance: 'City hilltop', score: 8.7, image: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?w=600&h=420&fit=crop&auto=format' },
    { id: 'alha-udal-memorial', name: 'Alha-Udal Memorial & Park', category: 'Cultural Monument', description: 'Memorial dedicated to legendary warrior brothers Alha and Udal with armor replicas, weapons, and murals.', duration: '1.5 hrs', distance: 'Central Mahoba', score: 8.5, image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=600&h=420&fit=crop&auto=format' }
  ],
  hiddenGems: [
    { name: 'Madan Sagar Lake & Chhatris', why: 'Tranquil 12th-century lake featuring stone pavilions (chhatris) and island temple ruins surrounded by lotus flowers.', distance: '2 km from center', duration: '1 hr', image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=800&h=500&fit=crop&auto=format' },
    { name: 'Gokhar Hill (Gorakhnath Shrine)', why: 'Rocky hill associated with Guru Gorakhnath with ancient caves, rock carvings, and panoramic valley views.', distance: '4 km from town', duration: '1.5 hrs', image: 'https://images.unsplash.com/photo-1544717305-2782549b5136?w=800&h=500&fit=crop&auto=format' }
  ],
  thingsToDo: [
    { activity: 'Sun Temple Architecture & Solar Align Tour', duration: '2 hrs', cost: '₹100–₹300', difficulty: 'Easy', bestTime: 'Sunrise', image: 'https://images.unsplash.com/photo-1600100397608-f010e423b961?w=600&h=400&fit=crop&auto=format' },
    { activity: 'Kirat Sagar Sunset Boating', duration: '1.5 hrs', cost: '₹100', difficulty: 'Easy', bestTime: '5:30 PM', image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=600&h=400&fit=crop&auto=format' },
    { activity: 'Alha Folk Ballad Performance Listening', duration: '2 hrs', cost: 'Free / Tip', difficulty: 'Easy', bestTime: 'Evening', image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=600&h=400&fit=crop&auto=format' }
  ],
  nearbyPlaces: [
    { name: 'Khajuraho (MP)', distance: '65 km', type: 'UNESCO World Heritage', travelTime: '1.2 hrs', image: 'https://images.unsplash.com/photo-1600100397608-f010e423b961?w=500&h=340&fit=crop&auto=format' },
    { name: 'Chitrakoot', distance: '125 km', type: 'Spiritual Holy Town', travelTime: '2.5 hrs', image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=500&h=340&fit=crop&auto=format' },
    { name: 'Kalinjar Fort', distance: '85 km', type: 'Impregnable Fort', travelTime: '2 hrs', image: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?w=500&h=340&fit=crop&auto=format' }
  ],
  travel: {
    air: { airport: 'Khajuraho Airport (HJR)', distance: '65 km', time: '1.2 hrs by taxi' },
    rail: { station: 'Mahoba Junction (MBA)', distance: 'City center', time: 'Connected to Delhi, Jhansi, Kanpur, Prayagraj' },
    road: { highway: 'NH-34 (Kanpur-Sagar Highway)', distance: 'Directly on NH-34', time: '3 hrs from Kanpur by road' }
  },
  stay: {
    categories: [
      { type: 'Budget', range: '₹600–₹1,200/night', options: ['Hotel Tourist Bungalow', 'Mahoba Lodge', 'Station Guest Houses'] },
      { type: 'Mid-Range', range: '₹1,500–₹3,000/night', options: ['Hotel Chandela Inn', 'UP Tourism Rahi Hotel', 'Lakeview Resort'] },
      { type: 'Heritage', range: '₹2,500–₹5,000/night', options: ['Khajuraho Heritage Stays (65 km)', 'Local Haveli Stays'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget Traveller', perDay: '₹1,200–₹1,800', breakdown: [{ category: 'Stay', amount: '₹600–₹900' }, { category: 'Food', amount: '₹250–₹400' }, { category: 'Transport', amount: '₹200–₹300' }, { category: 'Entry Fees', amount: '₹100' }, { category: 'Activities', amount: '₹150' }] },
      { tier: 'Comfort', perDay: '₹2,500–₹4,000', breakdown: [{ category: 'Stay', amount: '₹1,500–₹2,500' }, { category: 'Food', amount: '₹400–₹700' }, { category: 'Transport', amount: '₹300–₹500' }, { category: 'Entry Fees', amount: '₹150' }, { category: 'Activities', amount: '₹350' }] }
    ]
  },
  itineraries: {
    '1 Day': [{ day: 1, schedule: [{ time: '8:30 AM', place: 'Breakfast — Aloo Bada & Chai', duration: '30 min', distance: 'Town center' }, { time: '9:30 AM', place: 'Sun Temple (Surya Mandir Rahila)', duration: '2 hrs', distance: '3 km' }, { time: '12:00 PM', place: 'Mahoba Fort Ruins & Viewpoint', duration: '2 hrs', distance: 'Town hill' }, { time: '2:30 PM', place: 'Lunch — Bundeli Thali', duration: '1 hr', distance: 'City center' }, { time: '4:00 PM', place: 'Alha-Udal Memorial', duration: '1.5 hrs', distance: 'Central Mahoba' }, { time: '6:00 PM', place: 'Kirat Sagar Lake Sunset & Boating', duration: '1.5 hrs', distance: '1.5 km' }] }],
    '2 Days': [{ day: 1, schedule: [{ time: '9:00 AM', place: 'Sun Temple Rahila Sagar', duration: '2 hrs', distance: '3 km' }, { time: '11:30 AM', place: 'Madan Sagar Lake & Chhatris', duration: '1.5 hrs', distance: '2 km' }, { time: '4:30 PM', place: 'Kirat Sagar Sunset Walk & Alha Singing', duration: '2.5 hrs', distance: '1.5 km' }] }, { day: 2, schedule: [{ time: '8:30 AM', place: 'Gokhar Hill & Gorakhnath Caves Trek', duration: '2.5 hrs', distance: '4 km' }, { time: '12:00 PM', place: 'Mahoba Fort Heritage Exploration', duration: '2 hrs', distance: 'City hill' }, { time: '3:30 PM', place: 'Excursion to Kalinjar Fort or Khajuraho', duration: '4 hrs', distance: '65 km' }] }]
  },
  experiences: [
    { title: 'Chandela Dynasty Temple & Sun Alignment Walk', duration: '2.5 hrs', price: '₹350', category: 'Heritage', image: 'https://images.unsplash.com/photo-1600100397608-f010e423b961?w=600&h=400&fit=crop&auto=format' }
  ],
  aiPrompts: [
    'What is the historical story of Sun Temple Rahila Sagar in Mahoba?',
    'Tell me about the legendary warriors Alha and Udal of Mahoba',
    'How were the 52 lakes built by Chandela kings?'
  ],
  reviews: [
    { name: 'Ramesh Bundela', location: 'Jhansi', text: 'The Rahila Sun Temple is unbelievable. It deserves as much fame as Konark!', rating: 5, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&auto=format', date: 'Jan 2026' }
  ],
  sources: {
    official: ['UP Tourism Mahoba District', 'ASI Agra Circle'],
    historical: ['Alha-Khand Ballads', 'Chandela Dynasty Inscriptions'],
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={mahoba} />
      <QuickFacts facts={mahoba.quickFacts} />
      <WhyVisit destination={mahoba} />
      <DestinationStory destination={mahoba} />
      <HistoryTimeline destination={mahoba} />
      <CultureGrid destination={mahoba} />
      <FoodSection destination={mahoba} />
      <AttractionsGrid destination={mahoba} />
      <HiddenGems destination={mahoba} />
      <ThingsToDo destination={mahoba} />
      <NearbyPlaces destination={mahoba} />
      <HowToReach destination={mahoba} />
      <WhereToStay destination={mahoba} />
      <BestTime destination={mahoba} />
      <BudgetGuide destination={mahoba} />
      <Itineraries destination={mahoba} />
      <LocalExperiences destination={mahoba} />
      <MapSection destination={mahoba} />
      <AskD360 destination={mahoba} />
      <CommunityStories destination={mahoba} />
      <PracticalInfo />
      <SourcesTrust destination={mahoba} />
      <Footer />
    </div>
  )
}
