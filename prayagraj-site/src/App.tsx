...
const IMG_SANGAM = W + "Triveni Sangam.JPG?width=1600"
const IMG_SANGAM_BOAT = W + "Boat Pilgrims Triveni Sangam Allahabad Jan24 A7C 08513.jpg?width=1600"
const IMG_FORT = W + "Allahabad fort.jpg?width=1600"
const IMG_ANAND_BHAVAN = W + "Anand Bhawan, Allahabad.jpg?width=1600"
const IMG_KHUSRO_BAGH = W + "Khusro Bagh 8.jpg?width=1600"
const IMG_CATHEDRAL = W + "All Saints' Cathedral.jpg?width=1600"
const IMG_ARAIL_GHAT = W + "Arail-ghatt.jpg?width=1600"
const IMG_ULTA_QILA = W + "Ulta Kila, Jhunsi, Prayagraj.jpg?width=1600"
const IMG_HALWA = W + "Gajjar ka halwa (carrot halwa).JPG?width=1600"
const IMG_KACHORI = W + "Khasta kachori.jpg?width=1600"
const IMG_JALEBI = W + "Jalebi - Closeup View of Jalebis.JPG?width=1600"
const IMG_IMARTI = W + "Imarti.jpg?width=1600"
const IMG_GOLGAPPA = W + "Panipuri, Golgappa, Phuchka.jpg?width=1600"
const IMG_ROOT_VEG = W + "Shaluk,The Nymphaeaceae root vegetable.jpg?width=1600"
const IMG_VARANASI_NEARBY = W + "Varanasi,_India,_Ganges_River_after_sunset.jpg?width=1600"
const IMG_AYODHYA_NEARBY = W + "Ram Janmbhoomi Mandir, Ayodhya Dham.jpg?width=1600"
const IMG_CHITRAKOOT_NEARBY = W + "Ramghat.jpg?width=1600"
const IMG_HANUMAN_TEMPLE = W + "Hanuman Temple, Hampi.jpg?width=1600"

const prayagraj: Destination = {
  id: 'prayagraj', slug: 'prayagraj', name: 'Prayagraj', localName: 'प्रयागराज',
  destinationType: 'Spiritual / Pilgrimage City', country: 'India', state: 'Uttar Pradesh', district: 'Prayagraj',
  shortDescription: 'Home to the Triveni Sangam — the sacred confluence of the Ganga, Yamuna and mythical Saraswati rivers — Prayagraj is one of Hinduism\'s holiest pilgrimage cities and host to the Kumbh Mela, the world\'s largest religious gathering.',
  tags: ['Triveni Sangam', 'Kumbh Mela', 'Pilgrimage', 'Mughal Fort', 'Nehru Family History', 'Colonial Architecture'],
  hero: { image: IMG_SANGAM, poster: IMG_SANGAM_BOAT },
  quickFacts: {
    bestTime: 'October – March', duration: '1–2 Days (weeks during Kumbh)', budget: '₹₹',
    destinationType: 'Spiritual / Heritage', difficulty: 'Easy, very crowded during Mela season', distance: '12 km from Airport'
  },
  discoveryScore: {
    overall: 8.9,
    categories: [
      { name: 'Spiritual Experience', score: 9.7 },
      { name: 'Heritage Value', score: 8.8 },
      { name: 'Photography', score: 8.7 },
      { name: 'Food Scene', score: 8.2 },
      { name: 'Crowd Levels', score: 6.0 },
      { name: 'Accessibility', score: 7.3 }
    ]
  },
  editorial: {
    why: 'Prayagraj is built entirely around a single point in the river where three sacred waters meet — and once every twelve years that point becomes the site of the largest peaceful gathering of human beings on the planet.',
    story: 'At the Triveni Sangam, the visible Ganga and Yamuna converge with the mythical, invisible Saraswati. Beyond the river, the city holds a huge Mughal fort, the ancestral home of the Nehru-Gandhi family, and a Gothic cathedral — layers of history stacked on top of one of Hinduism\'s oldest pilgrimage sites.',
    storyFull: 'Prayagraj — known for most of the 20th century as Allahabad, before the state government restored its older Sanskrit name in 2018 — sits at the point where the Ganga and Yamuna rivers physically meet, joined according to Hindu belief by an invisible third river, the Saraswati. This confluence, the Triveni Sangam, is described in the Rigveda, Ramayana and Mahabharata, and taking a ritual dip here is considered spiritually equivalent to performing a thousand horse sacrifices. Every twelve years the site hosts the Maha Kumbh Mela, the largest religious gathering on Earth; the 2025 edition alone drew reported crowds in the hundreds of millions over its bathing dates, with the next Ardh (half) Kumbh expected around 2031. Just above the riverbank stands Akbar\'s 1583 Allahabad Fort, the largest fortification the Mughal emperor ever built, which encloses the ancient Akshayavat banyan tree and a third-century-BCE Ashokan pillar carrying inscriptions from three different emperors. A very different kind of history sits a few kilometers away at Anand Bhavan, the Nehru family\'s ancestral home and a key planning site of India\'s independence movement, now preserved as a museum. The city\'s Gothic-revival All Saints Cathedral and the walled Mughal garden-tombs of Khusro Bagh round out a downtown that layers pilgrimage, empire and the freedom struggle within a short rickshaw ride of each other.'
  },
  history: {
    shortIntro: 'Known as Allahabad for much of its modern history and renamed Prayagraj in 2018, this city has been a center of Hindu pilgrimage for millennia and a seat of Mughal and British colonial power more recently.',
    timeline: [
      { year: '232 BCE', event: 'Emperor Ashoka\'s pillar is erected, later re-inscribed by Samudragupta and Jahangir.', era: 'Ancient' },
      { year: '1575–1583', event: 'Emperor Akbar builds Allahabad Fort, his largest fortification, on the banks of the Yamuna near the Sangam.', era: 'Mughal' },
      { year: 'Early 17th century', event: 'Khusro Bagh\'s tombs are built for Prince Khusrau Mirza and his family.', era: 'Mughal' },
      { year: '1887', event: 'All Saints Cathedral (Patthar Girja) is completed, designed by architect William Emerson.', era: 'British Colonial' },
      { year: '1930', event: 'Motilal Nehru donates Swaraj Bhavan to the Indian National Congress; Anand Bhavan is built as the new family residence.', era: 'Independence Movement' },
      { year: '2018', event: 'The Uttar Pradesh government officially renames Allahabad to Prayagraj.', era: 'Contemporary' },
      { year: '2025', event: 'Prayagraj hosts the Maha Kumbh Mela, recorded as the largest religious gathering in history with over 660 million reported visits.', era: 'Contemporary' }
    ]
  },
  culture: [
    { title: 'The Kumbh Mela', description: 'Held at Prayagraj every twelve years (with smaller Ardh Kumbh and annual Magh Mela gatherings in between), the Kumbh Mela draws tens of millions of pilgrims for ritual bathing at the Sangam, alongside gatherings of Hindu ascetic orders (akharas).', image: IMG_SANGAM_BOAT },
    { title: 'Nehru-Gandhi Family Legacy', description: 'Anand Bhavan and Swaraj Bhavan preserve the rooms where Motilal Nehru, Jawaharlal Nehru and other freedom fighters lived and planned key moments of India\'s independence movement.', image: IMG_ANAND_BHAVAN },
    { title: 'Colonial and Mughal Layering', description: 'The Gothic-revival All Saints Cathedral stands in the same city as Akbar\'s largest fort and the Mughal-era tombs of Khusro Bagh, reflecting Prayagraj\'s long history as a seat of successive empires.', image: IMG_CATHEDRAL }
  ],
  food: [
    { name: 'Kaali Gajar Ka Halwa', description: 'A rare winter-only dessert made from black carrots, slow-cooked in milk to a deep purple-black halwa with an earthy, faintly smoky sweetness quite different from the usual orange-carrot version.', category: 'Dessert', price: '₹100–250', image: IMG_HALWA },
    { name: 'Kachori Sabzi', description: 'Prayagraj\'s breakfast staple: urad-dal-stuffed kachoris served with tangy aloo-chana sabzi, best found fresh and hot at Chowk and Civil Lines breakfast spots.', category: 'Breakfast', price: '₹40–80', image: IMG_KACHORI },
    { name: 'Dahi Jalebi', description: 'Hot, syrup-soaked jalebis paired with cool, thick curd — a classic hot-cold, sweet-tangy combination eaten as a mid-morning treat.', category: 'Sweet', price: '₹40–80', image: IMG_JALEBI },
    { name: 'Imarti', description: 'A urad-dal-batter cousin of jalebi, piped into flower-shaped spirals, fried and soaked in syrup — thicker, chewier and slightly tangier than its wheat-flour relative.', category: 'Sweet', price: '₹150–300/kg', image: IMG_IMARTI },
    { name: 'Dahi Sonth Ke Batashe', description: 'A milder, creamier local twist on golgappa/pani puri, filled with seasoned curd and sweet-tangy dried-ginger tamarind chutney instead of spiced water.', category: 'Street Food', price: '₹30–60', image: IMG_GOLGAPPA },
    { name: 'Kandmool', description: 'A starchy seasonal root sold near the Sangam, associated with the forest diet of Rama, Sita and Lakshmana during their exile, and often sold sliced with salt, pepper and lemon during Magh and Kumbh Mela.', category: 'Seasonal', price: '₹20–50', image: IMG_ROOT_VEG }
  ],
  attractions: [
    { id: 'triveni-sangam', name: 'Triveni Sangam', category: 'Sacred Confluence', description: 'The sacred meeting point of the Ganga, Yamuna and mythical Saraswati rivers, reachable by boat, and the epicenter of the Kumbh and Magh Mela pilgrimages.', duration: '1–2 hrs', distance: 'City center', score: 9.7, image: IMG_SANGAM },
    { id: 'allahabad-fort', name: 'Allahabad Fort', category: 'Fort', description: 'Akbar\'s largest fort, built in 1583 on the Yamuna near the Sangam, home to the ancient Akshayavat tree, an Ashokan pillar and (partly) closed sections under Indian Army control.', duration: '1–1.5 hrs', distance: 'Near Sangam', score: 8.9, image: IMG_FORT },
    { id: 'anand-bhavan', name: 'Anand Bhavan', category: 'Museum / Historic House', description: 'The Nehru family\'s ancestral mansion, now a museum documenting the family\'s role in India\'s independence movement, with a planetarium and vintage car collection.', duration: '1–1.5 hrs', distance: 'City center', score: 8.6, image: IMG_ANAND_BHAVAN },
    { id: 'khusro-bagh', name: 'Khusro Bagh', category: 'Mughal Garden & Tombs', description: 'A peaceful 40-acre walled Mughal garden containing the tombs of Prince Khusrau Mirza and his family, known for its guava orchards and quiet lawns.', duration: '45–60 min', distance: 'Near railway station', score: 8.3, image: IMG_KHUSRO_BAGH },
    { id: 'all-saints-cathedral', name: 'All Saints Cathedral (Patthar Girja)', category: 'Colonial Architecture', description: 'A striking 1887 Gothic-revival Anglican cathedral designed by William Emerson, with 175-foot spires and stained glass windows.', duration: '30–45 min', distance: 'Civil Lines area', score: 8.1, image: IMG_CATHEDRAL },
    { id: 'bade-hanuman-ji-temple', name: 'Bade Hanuman Ji Temple', category: 'Temple', description: 'A unique temple housing a 20-foot reclining Hanuman idol, perpetually half-submerged in water, located within the Allahabad Fort complex near the Sangam.', duration: '30–45 min', distance: 'Near Allahabad Fort', score: 8.0, image: IMG_HANUMAN_TEMPLE }
  ],
  hiddenGems: [
    { name: 'Arail Ghat', why: 'Located across the Yamuna in Jhunsi, this quieter ghat offers a panoramic view of the Sangam, the fort and the river confluence without the crowds of the main pilgrimage ghats.', distance: 'Across the river from Sangam', duration: '30–45 min', image: IMG_ARAIL_GHAT },
    { name: 'Ulta Qila (Upside Down Fort)', why: 'A mysterious, little-visited ruin in Jhunsi tied to local legend of a cursed, inverted fort — of real archaeological interest but rarely on standard tourist routes.', distance: 'Jhunsi, across the Ganga', duration: '45–60 min', image: IMG_ULTA_QILA }
  ],
  thingsToDo: [
    { activity: 'Boat ride to the exact Sangam confluence point', duration: '1–1.5 hrs', cost: '₹300–800 shared boat', difficulty: 'Easy', bestTime: 'Early morning or late afternoon', image: IMG_SANGAM_BOAT },
    { activity: 'Explore Anand Bhavan and Swaraj Bhavan museums', duration: '1.5–2 hrs', cost: '₹50–100 entry', difficulty: 'Easy', bestTime: 'Morning', image: IMG_ANAND_BHAVAN },
    { activity: 'Walk Khusro Bagh\'s gardens and Mughal tombs', duration: '45–60 min', cost: 'Free', difficulty: 'Easy', bestTime: 'Early morning or evening', image: IMG_KHUSRO_BAGH },
    { activity: 'Try Kaali Gajar Ka Halwa and Kachori Sabzi in Chowk', duration: '1–2 hrs', cost: '₹200–400', difficulty: 'Easy', bestTime: 'Morning / winter season for halwa', image: IMG_HALWA }
  ],
  nearbyPlaces: [
    { name: 'Varanasi', distance: '~120–150 km', type: 'Spiritual City', travelTime: '~2.5–3 hrs', image: IMG_VARANASI_NEARBY },
    { name: 'Ayodhya', distance: '~165 km', type: 'Pilgrimage City', travelTime: '~3–3.5 hrs', image: IMG_AYODHYA_NEARBY },
    { name: 'Chitrakoot', distance: '~130 km', type: 'Pilgrimage Town', travelTime: '~3 hrs', image: IMG_CHITRAKOOT_NEARBY }
  ],
  travel: {
    air: { airport: 'Prayagraj Airport (IXD), Bamrauli', distance: '~12 km from the city / Sangam', time: '20–30 min by road' },
    rail: { station: 'Prayagraj Junction', distance: '~5 km from Sangam', time: '15–20 min by auto/taxi' },
    road: { highway: 'NH19 / NH30 (Grand Trunk Road & Lucknow–Prayagraj corridors)', distance: '~120–150 km from Varanasi, ~165 km from Ayodhya', time: 'Varies by origin city' }
  },
  stay: {
    categories: [
      { type: 'Budget', range: '₹500–₹1,500/night', options: ['Dharamshalas near Sangam', 'Budget hotels in Civil Lines'] },
      { type: 'Mid-Range', range: '₹2,000–₹4,500/night', options: ['Riverside hotels with Sangam views', 'Standard hotels in Civil Lines/Chowk'] },
      { type: 'Luxury', range: '₹5,000+/night', options: ['Premium hotels and resorts, limited but expanding around Kumbh infrastructure'] }
    ]
  },
  bestTime: {
    months: [
  ...
  budget: {
    tiers: [
      { tier: 'Budget', perDay: '₹800–₹1,500', breakdown: [{ category: 'Accommodation (dharamshala/budget hotel)', amount: '₹400–700' }, { category: 'Food', amount: '₹250–400' }, { category: 'Boat ride (shared)', amount: '₹100–300' }, { category: 'Local transport', amount: '₹150–300' }] },
      { tier: 'Mid-Range', perDay: '₹2,000–₹4,000', breakdown: [{ category: 'Accommodation', amount: '₹1,800–3,000' }, { category: 'Food', amount: '₹500–800' }, { category: 'Private boat + guide', amount: '₹600–1,200' }, { category: 'Local transport (cab)', amount: '₹300–500' }] },
      { tier: 'Luxury', perDay: '₹5,500+', breakdown: [{ category: 'Accommodation', amount: '₹4,500+' }, { category: 'Food', amount: '₹800+' }, { category: 'Private guided city tour', amount: '₹1,500–2,500' }, { category: 'Chauffeured car', amount: '₹2,000+' }] }
    ]
  },
  itineraries: {
    '1 Day': [
      { day: 1, schedule: [
        { time: 'Morning', place: 'Boat ride to the Triveni Sangam confluence point for a ritual dip or darshan', duration: '1.5 hrs', distance: 'Triveni Sangam' },
        { time: 'Midday', place: 'Visit Allahabad Fort\'s open sections and Bade Hanuman Ji Temple nearby', duration: '1.5 hrs', distance: 'Allahabad Fort' },
        { time: 'Afternoon', place: 'Explore Anand Bhavan and Swaraj Bhavan museums', duration: '2 hrs', distance: 'Anand Bhavan' },
        { time: 'Evening', place: 'Walk Khusro Bagh at sunset and try local sweets in Chowk', duration: '1.5 hrs', distance: 'Khusro Bagh / Chowk' }
      ]}
    ],
    '2 Days': [
      { day: 1, schedule: [
        { time: 'Morning', place: 'Sangam boat ride and ritual dip', duration: '1.5 hrs', distance: 'Triveni Sangam' },
        { time: 'Afternoon', place: 'Allahabad Fort and Bade Hanuman Ji Temple', duration: '2 hrs', distance: 'Allahabad Fort' },
        { time: 'Evening', place: 'Khusro Bagh at sunset', duration: '1 hr', distance: 'Khusro Bagh' }
      ]},
      { day: 2, schedule: [
        { time: 'Morning', place: 'Anand Bhavan and Swaraj Bhavan museums', duration: '2 hrs', distance: 'Anand Bhavan' },
        { time: 'Afternoon', place: 'All Saints Cathedral, food trail in Chowk and Civil Lines', duration: '3 hrs', distance: 'Civil Lines / Chowk' }
      ]}
    ],
    '3 Days': [
      { day: 1, schedule: [{ time: 'Full Day', place: 'Sangam boat ride and ritual dip, Allahabad Fort, Bade Hanuman Ji Temple', duration: 'Full day', distance: 'Sangam / Fort' }] },
      { day: 2, schedule: [{ time: 'Full Day', place: 'Anand Bhavan, Swaraj Bhavan, All Saints Cathedral, Khusro Bagh', duration: 'Full day', distance: 'Civil Lines' }] },
      { day: 3, schedule: [{ time: 'Full Day', place: 'Cross to Arail Ghat and Ulta Qila for a quieter, hidden-gem day, followed by a local food trail', duration: 'Full day', distance: 'Jhunsi / Arail Ghat' }] }
    ]
  },
  experiences: [
    { title: 'Sangam Confluence Boat Ride', duration: '1–1.5 hrs', price: '₹300–1,000', category: 'Boat Ride', image: IMG_SANGAM_BOAT },
    { title: 'Nehru Family Heritage Walk', duration: '2 hrs', price: '₹500–1,000', category: 'History Tour', image: IMG_ANAND_BHAVAN },
    { title: 'Old City Sweets & Street Food Trail', duration: '2–3 hrs', price: '₹500–1,000', category: 'Food Tour', image: IMG_HALWA }
  ],
  aiPrompts: ["When is the next Kumbh Mela or Ardh Kumbh Mela in Prayagraj?", "Is it safe to take a boat ride to the Sangam with children?", "What's the difference between Magh Mela and Kumbh Mela?", "Can I visit Allahabad Fort fully, or are parts restricted?", "What should I pack if visiting during the Kumbh Mela?"],
  reviews: [
    { name: 'Traveler Review', location: 'Lucknow, India', text: 'Take the boat out to the exact confluence point at sunrise — it\'s worth the early start and much calmer than midday.', rating: 5, image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=80&h=80&fit=crop&auto=format', date: '2026' }
  ],
  sources: {
    official: ['Prayagraj District Administration — prayagraj.nic.in', 'Kumbh Mela official site — kumbh.gov.in'],
    historical: ['Wikipedia — Prayagraj, Triveni Sangam, Kumbh Mela, 2025 Prayag Maha Kumbh Mela', 'Airports Authority of India — Prayagraj Airport (IXD)'],
    ...
    <section className="bg-d360-bg py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="relative border border-d360-border bg-d360-surface overflow-hidden" style={{ height: '420px', borderRadius: '2px' }}>
          ...
          {/* Map pins */}
          {[{ top: '35%', left: '45%', label: 'Triveni Sangam' }, { top: '42%', left: '38%', label: 'Allahabad Fort' }, { top: '28%', left: '52%', label: 'Anand Bhavan' }].map(pin => (
            ...
            {!answered ? (
              ...
              <div className="min-h-[200px]">
                ...
                <div className="p-4 bg-white/5 border border-white/10 text-white/75 text-sm leading-relaxed" style={{ borderRadius: '2px' }}>
                  {selected?.includes('next Kumbh Mela') && `The last Maha Kumbh Mela was held at Prayagraj in January–February 2025, drawing record crowds. The next Ardh (half) Kumbh Mela is expected around 2031, with the following Maha Kumbh due in 2037 — dates are finalized closer to the event based on astrological calculations, so check official sources nearer the time.`}
                  {selected?.includes('boat ride to the Sangam') && `Yes, boat rides to the Sangam are generally safe and popular with families — boats are steady and the confluence point is calm rather than fast-flowing. Stick to licensed boatmen at the main ghats, agree on the fare beforehand, and make sure life jackets are worn, especially with young children.`}
                  {selected?.includes('Magh Mela') && `Magh Mela is a smaller, annual month-long pilgrimage held every winter at the Sangam, while Kumbh Mela is the much larger gathering held once every 12 years (with an Ardh Kumbh at the halfway point). Magh Mela still draws large crowds and has the same rituals, just at a fraction of Kumbh's scale.`}
                  {selected?.includes('Allahabad Fort') && `Most of Allahabad Fort is under Indian Army control and closed to the general public. Visitors can usually access the Bade Hanuman Ji Temple and a few outer sections; the Akshayavat tree inside Patalpuri Temple and other restricted areas open only occasionally, most notably during the Kumbh Mela.`}
                  {selected?.includes('pack if visiting') && `Pack comfortable walking shoes, weather-appropriate layers (Kumbh season runs cold mornings to mild afternoons), a reusable water bottle, hand sanitizer, a printed ID copy, and a small first-aid kit. Crowds are dense, so keep valuables minimal and secure, and carry a portable phone charger since networks get congested.`}
                </div>
              </div>
            )}
...
function PracticalInfo() {
  ...
  const items = [
    { title: 'Safety', content: 'Prayagraj is generally safe for tourists, but the ghats and markets around the Sangam attract touts and unofficial guides — agree on boat and guide prices upfront through your hotel or a licensed operator. Crowds intensify sharply during Magh Mela and Kumbh Mela, so keep valuables secure and agree on a meeting point with your group.' },
    { title: 'Local Transport', content: 'Auto-rickshaws and e-rickshaws cover most of the city; agree on fares before boarding, as they rarely use meters. Boats are the standard way to reach the exact Sangam confluence point. During Kumbh/Magh Mela, expect significant traffic diversions and long walks near the mela grounds.' },
    { title: 'Photography Rules', content: 'Photography is welcome at most sites including the Sangam and Allahabad Fort\'s open areas, but sections of the fort under Indian Army control restrict cameras entirely. Be respectful around active rituals and Pind Daan (ancestral) ceremonies at the ghats rather than photographing them up close.' },
    { title: 'Dress & Etiquette', content: 'Modest clothing covering shoulders and knees is expected at temples and during rituals at the ghats. Remove shoes before entering temples. During Kumbh and Magh Mela, dress for both crowds and weather — mornings can be cold even when afternoons are mild.' },
    { title: 'Emergency Information', content: 'Police: 100 · Ambulance: 108 · UP Tourist Helpline: 1800-180-1414 · Prayagraj Police Control: 0532-2440400. Major hospitals include SRN Hospital and Swaroop Rani Nehru Hospital, both within the city.' },
    { title: 'Travel Tips', content: 'Book a boat the evening before for a sunrise ride to the Sangam — fares are usually better negotiated in person at the ghat than online. If visiting during Kumbh or Magh Mela, book accommodation months ahead and allow extra time for security checks and crowd movement near the mela grounds.' }
  ]
  return (
    <section className="bg-d360-surface py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
...
export default function App() {
  return (
    <div className="bg-d360-bg font-sans">
      <Nav />
      <Hero destination={prayagraj} />
      <QuickFacts facts={prayagraj.quickFacts} />
      <WhyVisit destination={prayagraj} />
      <DestinationStory destination={prayagraj} />
      <HistoryTimeline destination={prayagraj} />
      <CultureGrid destination={prayagraj} />
      <FoodSection destination={prayagraj} />
      <AttractionsGrid destination={prayagraj} />
      <HiddenGems destination={prayagraj} />
      <ThingsToDo destination={prayagraj} />
      <NearbyPlaces destination={prayagraj} />
      <HowToReach destination={prayagraj} />
      <WhereToStay destination={prayagraj} />
      <BestTime destination={prayagraj} />
      <BudgetGuide destination={prayagraj} />
      <Itineraries destination={prayagraj} />
      <LocalExperiences destination={prayagraj} />
      <MapSection destination={prayagraj} />
      <AskD360 destination={prayagraj} />
      <CommunityStories destination={prayagraj} />
      <PracticalInfo />
      <SourcesTrust destination={prayagraj} />
      <Footer />
    </div>
  )
}
